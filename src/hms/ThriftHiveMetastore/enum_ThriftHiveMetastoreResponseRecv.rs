...
pub enum ThriftHiveMetastoreResponseRecv {
    ...
    CreateTableWithEnvironmentContext(
        ThriftHiveMetastoreCreateTableWithEnvironmentContextResultRecv,
    ),
    ...
    AddPartitionWithEnvironmentContext(
        ThriftHiveMetastoreAddPartitionWithEnvironmentContextResultRecv,
    ),
    ...
    AlterPartitionsWithEnvironmentContext(
        ThriftHiveMetastoreAlterPartitionsWithEnvironmentContextResultRecv,
    ),
    AlterPartitionWithEnvironmentContext(
        ThriftHiveMetastoreAlterPartitionWithEnvironmentContextResultRecv,
    ),
...
impl ::volo_thrift::EntryMessage for ThriftHiveMetastoreResponseRecv {
    ...
    async fn decode_async<T: ::pilota::thrift::TAsyncInputProtocol>(
        ...
        ::std::result::Result::Ok(match &*msg_ident.name {
                        "getMetaConf" => { Self::GetMetaConf(<ThriftHiveMetastoreGetMetaConfResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"setMetaConf" => { Self::SetMetaConf(<ThriftHiveMetastoreSetMetaConfResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"create_database" => { Self::CreateDatabase(<ThriftHiveMetastoreCreateDatabaseResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_database" => { Self::GetDatabase(<ThriftHiveMetastoreGetDatabaseResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_database" => { Self::DropDatabase(<ThriftHiveMetastoreDropDatabaseResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_databases" => { Self::GetDatabases(<ThriftHiveMetastoreGetDatabasesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_all_databases" => { Self::GetAllDatabases(<ThriftHiveMetastoreGetAllDatabasesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"alter_database" => { Self::AlterDatabase(<ThriftHiveMetastoreAlterDatabaseResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_type" => { Self::GetType(<ThriftHiveMetastoreGetTypeResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"create_type" => { Self::CreateType(<ThriftHiveMetastoreCreateTypeResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_type" => { Self::DropType(<ThriftHiveMetastoreDropTypeResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_type_all" => { Self::GetTypeAll(<ThriftHiveMetastoreGetTypeAllResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_fields" => { Self::GetFields(<ThriftHiveMetastoreGetFieldsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_fields_with_environment_context" => { Self::GetFieldsWithEnvironmentContext(<ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_schema" => { Self::GetSchema(<ThriftHiveMetastoreGetSchemaResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_schema_with_environment_context" => { Self::GetSchemaWithEnvironmentContext(<ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"create_table" => { Self::CreateTable(<ThriftHiveMetastoreCreateTableResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"create_table_with_environment_context" => { Self::CreateTableWithEnvironmentContext(<ThriftHiveMetastoreCreateTableWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"create_table_with_constraints" => { Self::CreateTableWithConstraints(<ThriftHiveMetastoreCreateTableWithConstraintsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_constraint" => { Self::DropConstraint(<ThriftHiveMetastoreDropConstraintResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"add_primary_key" => { Self::AddPrimaryKey(<ThriftHiveMetastoreAddPrimaryKeyResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"add_foreign_key" => { Self::AddForeignKey(<ThriftHiveMetastoreAddForeignKeyResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_table" => { Self::DropTable(<ThriftHiveMetastoreDropTableResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_table_with_environment_context" => { Self::DropTableWithEnvironmentContext(<ThriftHiveMetastoreDropTableWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_tables" => { Self::GetTables(<ThriftHiveMetastoreGetTablesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_tables_by_type" => { Self::GetTablesByType(<ThriftHiveMetastoreGetTablesByTypeResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_table_meta" => { Self::GetTableMeta(<ThriftHiveMetastoreGetTableMetaResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_all_tables" => { Self::GetAllTables(<ThriftHiveMetastoreGetAllTablesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_table" => { Self::GetTable(<ThriftHiveMetastoreGetTableResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_table_objects_by_name" => { Self::GetTableObjectsByName(<ThriftHiveMetastoreGetTableObjectsByNameResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_table_req" => { Self::GetTableReq(<ThriftHiveMetastoreGetTableReqResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_table_objects_by_name_req" => { Self::GetTableObjectsByNameReq(<ThriftHiveMetastoreGetTableObjectsByNameReqResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_table_names_by_filter" => { Self::GetTableNamesByFilter(<ThriftHiveMetastoreGetTableNamesByFilterResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"alter_table" => { Self::AlterTable(<ThriftHiveMetastoreAlterTableResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"alter_table_with_environment_context" => { Self::AlterTableWithEnvironmentContext(<ThriftHiveMetastoreAlterTableWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"alter_table_with_cascade" => { Self::AlterTableWithCascade(<ThriftHiveMetastoreAlterTableWithCascadeResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"add_partition" => { Self::AddPartition(<ThriftHiveMetastoreAddPartitionResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"add_partition_with_environment_context" => { Self::AddPartitionWithEnvironmentContext(<ThriftHiveMetastoreAddPartitionWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"add_partitions" => { Self::AddPartitions(<ThriftHiveMetastoreAddPartitionsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"add_partitions_pspec" => { Self::AddPartitionsPspec(<ThriftHiveMetastoreAddPartitionsPspecResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"append_partition" => { Self::AppendPartition(<ThriftHiveMetastoreAppendPartitionResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"add_partitions_req" => { Self::AddPartitionsReq(<ThriftHiveMetastoreAddPartitionsReqResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"append_partition_with_environment_context" => { Self::AppendPartitionWithEnvironmentContext(<ThriftHiveMetastoreAppendPartitionWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"append_partition_by_name" => { Self::AppendPartitionByName(<ThriftHiveMetastoreAppendPartitionByNameResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"append_partition_by_name_with_environment_context" => { Self::AppendPartitionByNameWithEnvironmentContext(<ThriftHiveMetastoreAppendPartitionByNameWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_partition" => { Self::DropPartition(<ThriftHiveMetastoreDropPartitionResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_partition_with_environment_context" => { Self::DropPartitionWithEnvironmentContext(<ThriftHiveMetastoreDropPartitionWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_partition_by_name" => { Self::DropPartitionByName(<ThriftHiveMetastoreDropPartitionByNameResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_partition_by_name_with_environment_context" => { Self::DropPartitionByNameWithEnvironmentContext(<ThriftHiveMetastoreDropPartitionByNameWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_partitions_req" => { Self::DropPartitionsReq(<ThriftHiveMetastoreDropPartitionsReqResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partition" => { Self::GetPartition(<ThriftHiveMetastoreGetPartitionResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"exchange_partition" => { Self::ExchangePartition(<ThriftHiveMetastoreExchangePartitionResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"exchange_partitions" => { Self::ExchangePartitions(<ThriftHiveMetastoreExchangePartitionsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partition_with_auth" => { Self::GetPartitionWithAuth(<ThriftHiveMetastoreGetPartitionWithAuthResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partition_by_name" => { Self::GetPartitionByName(<ThriftHiveMetastoreGetPartitionByNameResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partitions" => { Self::GetPartitions(<ThriftHiveMetastoreGetPartitionsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partitions_with_auth" => { Self::GetPartitionsWithAuth(<ThriftHiveMetastoreGetPartitionsWithAuthResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partitions_pspec" => { Self::GetPartitionsPspec(<ThriftHiveMetastoreGetPartitionsPspecResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partition_names" => { Self::GetPartitionNames(<ThriftHiveMetastoreGetPartitionNamesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partition_values" => { Self::GetPartitionValues(<ThriftHiveMetastoreGetPartitionValuesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partitions_ps" => { Self::GetPartitionsPs(<ThriftHiveMetastoreGetPartitionsPsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partitions_ps_with_auth" => { Self::GetPartitionsPsWithAuth(<ThriftHiveMetastoreGetPartitionsPsWithAuthResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partition_names_ps" => { Self::GetPartitionNamesPs(<ThriftHiveMetastoreGetPartitionNamesPsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partitions_by_filter" => { Self::GetPartitionsByFilter(<ThriftHiveMetastoreGetPartitionsByFilterResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_part_specs_by_filter" => { Self::GetPartSpecsByFilter(<ThriftHiveMetastoreGetPartSpecsByFilterResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partitions_by_expr" => { Self::GetPartitionsByExpr(<ThriftHiveMetastoreGetPartitionsByExprResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_num_partitions_by_filter" => { Self::GetNumPartitionsByFilter(<ThriftHiveMetastoreGetNumPartitionsByFilterResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partitions_by_names" => { Self::GetPartitionsByNames(<ThriftHiveMetastoreGetPartitionsByNamesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"alter_partition" => { Self::AlterPartition(<ThriftHiveMetastoreAlterPartitionResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"alter_partitions" => { Self::AlterPartitions(<ThriftHiveMetastoreAlterPartitionsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"alter_partitions_with_environment_context" => { Self::AlterPartitionsWithEnvironmentContext(<ThriftHiveMetastoreAlterPartitionsWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"alter_partition_with_environment_context" => { Self::AlterPartitionWithEnvironmentContext(<ThriftHiveMetastoreAlterPartitionWithEnvironmentContextResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"rename_partition" => { Self::RenamePartition(<ThriftHiveMetastoreRenamePartitionResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"partition_name_has_valid_characters" => { Self::PartitionNameHasValidCharacters(<ThriftHiveMetastorePartitionNameHasValidCharactersResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_config_value" => { Self::GetConfigValue(<ThriftHiveMetastoreGetConfigValueResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"partition_name_to_vals" => { Self::PartitionNameToVals(<ThriftHiveMetastorePartitionNameToValsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"partition_name_to_spec" => { Self::PartitionNameToSpec(<ThriftHiveMetastorePartitionNameToSpecResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"markPartitionForEvent" => { Self::MarkPartitionForEvent(<ThriftHiveMetastoreMarkPartitionForEventResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"isPartitionMarkedForEvent" => { Self::IsPartitionMarkedForEvent(<ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"add_index" => { Self::AddIndex(<ThriftHiveMetastoreAddIndexResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"alter_index" => { Self::AlterIndex(<ThriftHiveMetastoreAlterIndexResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_index_by_name" => { Self::DropIndexByName(<ThriftHiveMetastoreDropIndexByNameResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_index_by_name" => { Self::GetIndexByName(<ThriftHiveMetastoreGetIndexByNameResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_indexes" => { Self::GetIndexes(<ThriftHiveMetastoreGetIndexesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_index_names" => { Self::GetIndexNames(<ThriftHiveMetastoreGetIndexNamesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_primary_keys" => { Self::GetPrimaryKeys(<ThriftHiveMetastoreGetPrimaryKeysResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_foreign_keys" => { Self::GetForeignKeys(<ThriftHiveMetastoreGetForeignKeysResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"update_table_column_statistics" => { Self::UpdateTableColumnStatistics(<ThriftHiveMetastoreUpdateTableColumnStatisticsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"update_partition_column_statistics" => { Self::UpdatePartitionColumnStatistics(<ThriftHiveMetastoreUpdatePartitionColumnStatisticsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_table_column_statistics" => { Self::GetTableColumnStatistics(<ThriftHiveMetastoreGetTableColumnStatisticsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partition_column_statistics" => { Self::GetPartitionColumnStatistics(<ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_table_statistics_req" => { Self::GetTableStatisticsReq(<ThriftHiveMetastoreGetTableStatisticsReqResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_partitions_statistics_req" => { Self::GetPartitionsStatisticsReq(<ThriftHiveMetastoreGetPartitionsStatisticsReqResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_aggr_stats_for" => { Self::GetAggrStatsFor(<ThriftHiveMetastoreGetAggrStatsForResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"set_aggr_stats_for" => { Self::SetAggrStatsFor(<ThriftHiveMetastoreSetAggrStatsForResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"delete_partition_column_statistics" => { Self::DeletePartitionColumnStatistics(<ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"delete_table_column_statistics" => { Self::DeleteTableColumnStatistics(<ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"create_function" => { Self::CreateFunction(<ThriftHiveMetastoreCreateFunctionResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_function" => { Self::DropFunction(<ThriftHiveMetastoreDropFunctionResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"alter_function" => { Self::AlterFunction(<ThriftHiveMetastoreAlterFunctionResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_functions" => { Self::GetFunctions(<ThriftHiveMetastoreGetFunctionsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_function" => { Self::GetFunction(<ThriftHiveMetastoreGetFunctionResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_all_functions" => { Self::GetAllFunctions(<ThriftHiveMetastoreGetAllFunctionsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"create_role" => { Self::CreateRole(<ThriftHiveMetastoreCreateRoleResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"drop_role" => { Self::DropRole(<ThriftHiveMetastoreDropRoleResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_role_names" => { Self::GetRoleNames(<ThriftHiveMetastoreGetRoleNamesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"grant_role" => { Self::GrantRole(<ThriftHiveMetastoreGrantRoleResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"revoke_role" => { Self::RevokeRole(<ThriftHiveMetastoreRevokeRoleResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"list_roles" => { Self::ListRoles(<ThriftHiveMetastoreListRolesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"grant_revoke_role" => { Self::GrantRevokeRole(<ThriftHiveMetastoreGrantRevokeRoleResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_principals_in_role" => { Self::GetPrincipalsInRole(<ThriftHiveMetastoreGetPrincipalsInRoleResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_role_grants_for_principal" => { Self::GetRoleGrantsForPrincipal(<ThriftHiveMetastoreGetRoleGrantsForPrincipalResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_privilege_set" => { Self::GetPrivilegeSet(<ThriftHiveMetastoreGetPrivilegeSetResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"list_privileges" => { Self::ListPrivileges(<ThriftHiveMetastoreListPrivilegesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"grant_privileges" => { Self::GrantPrivileges(<ThriftHiveMetastoreGrantPrivilegesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"revoke_privileges" => { Self::RevokePrivileges(<ThriftHiveMetastoreRevokePrivilegesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"grant_revoke_privileges" => { Self::GrantRevokePrivileges(<ThriftHiveMetastoreGrantRevokePrivilegesResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"set_ugi" => { Self::SetUgi(<ThriftHiveMetastoreSetUgiResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_delegation_token" => { Self::GetDelegationToken(<ThriftHiveMetastoreGetDelegationTokenResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"renew_delegation_token" => { Self::RenewDelegationToken(<ThriftHiveMetastoreRenewDelegationTokenResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"cancel_delegation_token" => { Self::CancelDelegationToken(<ThriftHiveMetastoreCancelDelegationTokenResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"add_token" => { Self::AddToken(<ThriftHiveMetastoreAddTokenResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"remove_token" => { Self::RemoveToken(<ThriftHiveMetastoreRemoveTokenResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_token" => { Self::GetToken(<ThriftHiveMetastoreGetTokenResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_all_token_identifiers" => { Self::GetAllTokenIdentifiers(<ThriftHiveMetastoreGetAllTokenIdentifiersResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"add_master_key" => { Self::AddMasterKey(<ThriftHiveMetastoreAddMasterKeyResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"update_master_key" => { Self::UpdateMasterKey(<ThriftHiveMetastoreUpdateMasterKeyResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"remove_master_key" => { Self::RemoveMasterKey(<ThriftHiveMetastoreRemoveMasterKeyResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_master_keys" => { Self::GetMasterKeys(<ThriftHiveMetastoreGetMasterKeysResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_open_txns" => { Self::GetOpenTxns(<ThriftHiveMetastoreGetOpenTxnsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_open_txns_info" => { Self::GetOpenTxnsInfo(<ThriftHiveMetastoreGetOpenTxnsInfoResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"open_txns" => { Self::OpenTxns(<ThriftHiveMetastoreOpenTxnsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"abort_txn" => { Self::AbortTxn(<ThriftHiveMetastoreAbortTxnResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"abort_txns" => { Self::AbortTxns(<ThriftHiveMetastoreAbortTxnsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"commit_txn" => { Self::CommitTxn(<ThriftHiveMetastoreCommitTxnResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"lock" => { Self::Lock(<ThriftHiveMetastoreLockResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"check_lock" => { Self::CheckLock(<ThriftHiveMetastoreCheckLockResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"unlock" => { Self::Unlock(<ThriftHiveMetastoreUnlockResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"show_locks" => { Self::ShowLocks(<ThriftHiveMetastoreShowLocksResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"heartbeat" => { Self::Heartbeat(<ThriftHiveMetastoreHeartbeatResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"heartbeat_txn_range" => { Self::HeartbeatTxnRange(<ThriftHiveMetastoreHeartbeatTxnRangeResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"compact" => { Self::Compact(<ThriftHiveMetastoreCompactResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"compact2" => { Self::Compact2(<ThriftHiveMetastoreCompact2ResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"show_compact" => { Self::ShowCompact(<ThriftHiveMetastoreShowCompactResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"add_dynamic_partitions" => { Self::AddDynamicPartitions(<ThriftHiveMetastoreAddDynamicPartitionsResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_next_notification" => { Self::GetNextNotification(<ThriftHiveMetastoreGetNextNotificationResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_current_notificationEventId" => { Self::GetCurrentNotificationEventId(<ThriftHiveMetastoreGetCurrentNotificationEventIdResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"fire_listener_event" => { Self::FireListenerEvent(<ThriftHiveMetastoreFireListenerEventResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"flushCache" => { Self::FlushCache(<ThriftHiveMetastoreFlushCacheResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_file_metadata_by_expr" => { Self::GetFileMetadataByExpr(<ThriftHiveMetastoreGetFileMetadataByExprResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"get_file_metadata" => { Self::GetFileMetadata(<ThriftHiveMetastoreGetFileMetadataResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"put_file_metadata" => { Self::PutFileMetadata(<ThriftHiveMetastorePutFileMetadataResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"clear_file_metadata" => { Self::ClearFileMetadata(<ThriftHiveMetastoreClearFileMetadataResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },"cache_file_metadata" => { Self::CacheFileMetadata(<ThriftHiveMetastoreCacheFileMetadataResultRecv as ::pilota::thrift::Message>::decode_async(__protocol).await?) },
                        _ => {
