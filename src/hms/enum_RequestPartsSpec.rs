...
impl ::std::default::Default for RequestPartsSpec {
    fn default() -> Self {
        RequestPartsSpec::Names(::std::default::Default::default())
    }
}
...
pub enum RequestPartsSpec {
    ...
    Exprs(::std::vec::Vec<DropPartitionsExpr>),
}

impl ::pilota::thrift::Message for RequestPartsSpec {
            ...
            match field_ident.id {
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(RequestPartsSpec::Names(field_ident));
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = unsafe {
                            let list_ident = __protocol.read_list_begin()?;
                            let mut val: ::std::vec::Vec<DropPartitionsExpr> =
                                ::std::vec::Vec::with_capacity(list_ident.size);
                            for i in 0..list_ident.size {
                                val.as_mut_ptr()
                                    .offset(i as isize)
                        ...
                        ret = Some(RequestPartsSpec::Exprs(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                    ...
                    Some(2) => {
                        if ret.is_none() {
                            let field_ident = {
                                ...
                                let mut val = ::std::vec::Vec::with_capacity(list_ident.size);
                                for _ in 0..list_ident.size {
                                    val.push(<DropPartitionsExpr as ::pilota::thrift::Message>::decode_async(__protocol).await?);
                                }
                                __protocol.read_list_end().await?;
                                val
                            };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            RequestPartsSpec::Names(value) => __protocol.list_field_len(
                Some(1),
                ::pilota::thrift::TType::Binary,
                value,
                |__protocol, el| __protocol.faststr_len(el),
            ),
            RequestPartsSpec::Exprs(value) => __protocol.list_field_len(
                Some(2),
                ::pilota::thrift::TType::Struct,
                value,
                |__protocol, el| __protocol.struct_len(el),
