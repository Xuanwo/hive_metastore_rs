...
impl ::std::default::Default for ThriftHiveMetastoreAddForeignKeyException {
    fn default() -> Self {
        ThriftHiveMetastoreAddForeignKeyException::O1(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreAddForeignKeyException {
    O1(NoSuchObjectException),

    O2(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreAddForeignKeyException {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreAddForeignKeyException",
        })?;
        match self {
            ThriftHiveMetastoreAddForeignKeyException::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreAddForeignKeyException::O2(value) => {
            ...
            match field_ident.id {
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreAddForeignKeyException::O1(field_ident));
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreAddForeignKeyException::O2(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
