...
impl ::std::default::Default for ThriftHiveMetastoreAlterTableWithCascadeException {
    fn default() -> Self {
        ThriftHiveMetastoreAlterTableWithCascadeException::O1(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreAlterTableWithCascadeException {
    O1(InvalidOperationException),

    O2(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreAlterTableWithCascadeException {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreAlterTableWithCascadeException",
        })?;
        match self {
            ThriftHiveMetastoreAlterTableWithCascadeException::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreAlterTableWithCascadeException::O2(value) => {
            ...
            match field_ident.id {
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreAlterTableWithCascadeException::O1(
                            field_ident,
                        ));
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreAlterTableWithCascadeException::O2(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
