...
impl ::std::default::Default for ThriftHiveMetastoreAlterTableWithEnvironmentContextException {
    fn default() -> Self {
        ThriftHiveMetastoreAlterTableWithEnvironmentContextException::O1(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreAlterTableWithEnvironmentContextException {
    O1(InvalidOperationException),

    O2(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreAlterTableWithEnvironmentContextException {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreAlterTableWithEnvironmentContextException",
        })?;
        match self {
            ThriftHiveMetastoreAlterTableWithEnvironmentContextException::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreAlterTableWithEnvironmentContextException::O2(value) => {
            ...
            match field_ident.id {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreAlterTableWithEnvironmentContextException::O2(
                                field_ident,
                            ),
                        );
                    } else {
