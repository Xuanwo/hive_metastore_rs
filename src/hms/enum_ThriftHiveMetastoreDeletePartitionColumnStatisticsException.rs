...
impl ::std::default::Default for ThriftHiveMetastoreDeletePartitionColumnStatisticsException {
    fn default() -> Self {
        ThriftHiveMetastoreDeletePartitionColumnStatisticsException::O1(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreDeletePartitionColumnStatisticsException {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreDeletePartitionColumnStatisticsException {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDeletePartitionColumnStatisticsException",
        })?;
        match self {
            ThriftHiveMetastoreDeletePartitionColumnStatisticsException::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeletePartitionColumnStatisticsException::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeletePartitionColumnStatisticsException::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeletePartitionColumnStatisticsException::O4(value) => {
            ...
            match field_ident.id {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeletePartitionColumnStatisticsException::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeletePartitionColumnStatisticsException::O3(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(4) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeletePartitionColumnStatisticsException::O4(
                                field_ident,
                            ),
                        );
                    } else {
