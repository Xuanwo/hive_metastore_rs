...
impl ::std::default::Default for ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv {
    Ok(bool),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv::O4(value) => {
            ...
            match field_ident.id {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(
                            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv::O1(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv::O3(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(4) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultRecv::O4(
                                field_ident,
                            ),
                        );
                    } else {
