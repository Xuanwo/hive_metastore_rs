...
impl ::std::default::Default for ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend {
    Ok(bool),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend",
        })?;
        match self {
            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend::O4(value) => {
            ...
            match field_ident.id {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(
                            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend::O1(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend::O3(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(4) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeletePartitionColumnStatisticsResultSend::O4(
                                field_ident,
                            ),
                        );
                    } else {
