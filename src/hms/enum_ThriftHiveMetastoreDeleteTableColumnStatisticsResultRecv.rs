...
impl ::std::default::Default for ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv {
    Ok(bool),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv::O4(value) => {
            ...
            match field_ident.id {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(
                            ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv::O1(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv::O3(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(4) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeleteTableColumnStatisticsResultRecv::O4(
                                field_ident,
                            ),
                        );
                    } else {
