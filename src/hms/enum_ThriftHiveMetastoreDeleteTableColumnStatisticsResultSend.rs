...
impl ::std::default::Default for ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend {
    Ok(bool),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend",
        })?;
        match self {
            ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend::O4(value) => {
            ...
            match field_ident.id {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(
                            ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend::O1(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend::O3(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(4) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreDeleteTableColumnStatisticsResultSend::O4(
                                field_ident,
                            ),
                        );
                    } else {
