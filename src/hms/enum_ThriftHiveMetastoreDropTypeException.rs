...
impl ::std::default::Default for ThriftHiveMetastoreDropTypeException {
    fn default() -> Self {
        ThriftHiveMetastoreDropTypeException::O1(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreDropTypeException {
    O1(MetaException),

    O2(NoSuchObjectException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreDropTypeException {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDropTypeException",
        })?;
        match self {
            ThriftHiveMetastoreDropTypeException::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreDropTypeException::O2(value) => {
            ...
            match field_ident.id {
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreDropTypeException::O1(field_ident));
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreDropTypeException::O2(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
