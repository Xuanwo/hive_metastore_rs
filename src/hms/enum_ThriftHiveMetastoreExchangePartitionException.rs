...
impl ::std::default::Default for ThriftHiveMetastoreExchangePartitionException {
    fn default() -> Self {
        ThriftHiveMetastoreExchangePartitionException::O1(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreExchangePartitionException {
    O1(MetaException),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreExchangePartitionException {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreExchangePartitionException",
        })?;
        match self {
            ThriftHiveMetastoreExchangePartitionException::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreExchangePartitionException::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreExchangePartitionException::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreExchangePartitionException::O4(value) => {
            ...
            match field_ident.id {
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreExchangePartitionException::O1(
                            field_ident,
                        ));
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreExchangePartitionException::O2(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(3) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreExchangePartitionException::O3(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(4) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreExchangePartitionException::O4(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
