...
impl ::std::default::Default for ThriftHiveMetastoreGetAllDatabasesResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGetAllDatabasesResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetAllDatabasesResultSend {
    Ok(::std::vec::Vec<::pilota::FastStr>),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetAllDatabasesResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetAllDatabasesResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGetAllDatabasesResultSend::Ok(value) => {
            ...
            ThriftHiveMetastoreGetAllDatabasesResultSend::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetAllDatabasesResultSend::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetAllDatabasesResultSend::O1(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetAllDatabasesResultSend::Ok(value) => __protocol.list_field_len(
                Some(0),
                ::pilota::thrift::TType::Binary,
                value,
                |__protocol, el| __protocol.faststr_len(el),
