...
impl ::std::default::Default for ThriftHiveMetastoreGetAllTokenIdentifiersResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetAllTokenIdentifiersResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetAllTokenIdentifiersResultRecv {
    Ok(::std::vec::Vec<::pilota::FastStr>),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetAllTokenIdentifiersResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetAllTokenIdentifiersResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGetAllTokenIdentifiersResultRecv::Ok(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetAllTokenIdentifiersResultRecv::Ok(
                            field_ident,
                        ));
                    } else {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetAllTokenIdentifiersResultRecv::Ok(value) => __protocol
                .list_field_len(
                    Some(0),
                    ::pilota::thrift::TType::Binary,
                    value,
