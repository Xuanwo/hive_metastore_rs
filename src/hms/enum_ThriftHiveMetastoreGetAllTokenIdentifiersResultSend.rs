...
impl ::std::default::Default for ThriftHiveMetastoreGetAllTokenIdentifiersResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGetAllTokenIdentifiersResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetAllTokenIdentifiersResultSend {
    Ok(::std::vec::Vec<::pilota::FastStr>),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetAllTokenIdentifiersResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetAllTokenIdentifiersResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGetAllTokenIdentifiersResultSend::Ok(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetAllTokenIdentifiersResultSend::Ok(
                            field_ident,
                        ));
                    } else {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetAllTokenIdentifiersResultSend::Ok(value) => __protocol
                .list_field_len(
                    Some(0),
                    ::pilota::thrift::TType::Binary,
                    value,
