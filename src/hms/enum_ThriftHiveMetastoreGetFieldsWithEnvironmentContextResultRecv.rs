...
impl ::std::default::Default for ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv::Ok(value) => {
            ...
            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv::O3(value) => {
            ...
            match field_ident.id {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(
                            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv::O1(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv::O3(
                                field_ident,
                            ),
                        );
                    } else {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultRecv::Ok(value) => __protocol
                .list_field_len(
                    Some(0),
                    ::pilota::thrift::TType::Struct,
                    value,
