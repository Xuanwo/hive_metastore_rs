...
impl ::std::default::Default for ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend::Ok(value) => {
            ...
            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend::O3(value) => {
            ...
            match field_ident.id {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(
                            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend::O1(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend::O3(
                                field_ident,
                            ),
                        );
                    } else {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetFieldsWithEnvironmentContextResultSend::Ok(value) => __protocol
                .list_field_len(
                    Some(0),
                    ::pilota::thrift::TType::Struct,
                    value,
