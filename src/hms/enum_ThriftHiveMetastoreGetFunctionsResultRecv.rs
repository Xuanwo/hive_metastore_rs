...
impl ::std::default::Default for ThriftHiveMetastoreGetFunctionsResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetFunctionsResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetFunctionsResultRecv {
    Ok(::std::vec::Vec<::pilota::FastStr>),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetFunctionsResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetFunctionsResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGetFunctionsResultRecv::Ok(value) => {
            ...
            ThriftHiveMetastoreGetFunctionsResultRecv::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetFunctionsResultRecv::Ok(field_ident));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetFunctionsResultRecv::O1(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetFunctionsResultRecv::Ok(value) => __protocol.list_field_len(
                Some(0),
                ::pilota::thrift::TType::Binary,
                value,
                |__protocol, el| __protocol.faststr_len(el),
