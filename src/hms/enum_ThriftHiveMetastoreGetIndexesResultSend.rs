...
impl ::std::default::Default for ThriftHiveMetastoreGetIndexesResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGetIndexesResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetIndexesResultSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetIndexesResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetIndexesResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGetIndexesResultSend::Ok(value) => {
            ...
            ThriftHiveMetastoreGetIndexesResultSend::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetIndexesResultSend::O2(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetIndexesResultSend::Ok(field_ident));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetIndexesResultSend::O1(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreGetIndexesResultSend::O2(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetIndexesResultSend::Ok(value) => __protocol.list_field_len(
                Some(0),
                ::pilota::thrift::TType::Struct,
                value,
                |__protocol, el| __protocol.struct_len(el),
