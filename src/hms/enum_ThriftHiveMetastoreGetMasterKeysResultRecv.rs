...
impl ::std::default::Default for ThriftHiveMetastoreGetMasterKeysResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetMasterKeysResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetMasterKeysResultRecv {
    Ok(::std::vec::Vec<::pilota::FastStr>),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetMasterKeysResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetMasterKeysResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGetMasterKeysResultRecv::Ok(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetMasterKeysResultRecv::Ok(field_ident));
                    } else {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetMasterKeysResultRecv::Ok(value) => __protocol.list_field_len(
                Some(0),
                ::pilota::thrift::TType::Binary,
                value,
                |__protocol, el| __protocol.faststr_len(el),
