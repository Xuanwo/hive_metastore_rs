...
impl ::std::default::Default for ThriftHiveMetastoreGetMasterKeysResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGetMasterKeysResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetMasterKeysResultSend {
    Ok(::std::vec::Vec<::pilota::FastStr>),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetMasterKeysResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetMasterKeysResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGetMasterKeysResultSend::Ok(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetMasterKeysResultSend::Ok(field_ident));
                    } else {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetMasterKeysResultSend::Ok(value) => __protocol.list_field_len(
                Some(0),
                ::pilota::thrift::TType::Binary,
                value,
                |__protocol, el| __protocol.faststr_len(el),
