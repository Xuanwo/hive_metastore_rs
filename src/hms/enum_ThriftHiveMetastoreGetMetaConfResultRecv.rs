...
impl ::std::default::Default for ThriftHiveMetastoreGetMetaConfResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetMetaConfResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetMetaConfResultRecv {
    Ok(::pilota::FastStr),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetMetaConfResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetMetaConfResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGetMetaConfResultRecv::Ok(value) => {
                __protocol.write_faststr_field(0, (value).clone())?;
            }
            ThriftHiveMetastoreGetMetaConfResultRecv::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetMetaConfResultRecv::Ok(field_ident));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetMetaConfResultRecv::O1(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
