...
impl ::std::default::Default for ThriftHiveMetastoreGetPartSpecsByFilterResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartSpecsByFilterResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetPartSpecsByFilterResultRecv {
    Ok(::std::vec::Vec<PartitionSpec>),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartSpecsByFilterResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartSpecsByFilterResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGetPartSpecsByFilterResultRecv::Ok(value) => {
            ...
            ThriftHiveMetastoreGetPartSpecsByFilterResultRecv::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartSpecsByFilterResultRecv::O2(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        let field_ident = unsafe {
                            ...
                            let mut val: ::std::vec::Vec<PartitionSpec> =
                        ...
                        ret = Some(ThriftHiveMetastoreGetPartSpecsByFilterResultRecv::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetPartSpecsByFilterResultRecv::O1(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreGetPartSpecsByFilterResultRecv::O2(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                        ...
                        if ret.is_none() {
                            let field_ident = {
                                ...
                                for _ in 0..list_ident.size {
                                    val.push(
                                        <PartitionSpec as ::pilota::thrift::Message>::decode_async(
                                            __protocol,
                                        )
                                        .await?,
                                    );
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetPartSpecsByFilterResultRecv::Ok(value) => __protocol
                .list_field_len(
                    Some(0),
                    ::pilota::thrift::TType::Struct,
                    value,
