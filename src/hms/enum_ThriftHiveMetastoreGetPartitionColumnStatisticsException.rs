...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionColumnStatisticsException {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartitionColumnStatisticsException::O1(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetPartitionColumnStatisticsException {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionColumnStatisticsException {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionColumnStatisticsException",
        })?;
        match self {
            ThriftHiveMetastoreGetPartitionColumnStatisticsException::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartitionColumnStatisticsException::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartitionColumnStatisticsException::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartitionColumnStatisticsException::O4(value) => {
            ...
            match field_ident.id {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetPartitionColumnStatisticsException::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetPartitionColumnStatisticsException::O3(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(4) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetPartitionColumnStatisticsException::O4(
                                field_ident,
                            ),
                        );
                    } else {
