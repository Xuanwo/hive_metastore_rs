...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv {
    Ok(ColumnStatistics),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv::Ok(value) => {
                __protocol.write_struct_field(0, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv::O4(value) => {
            ...
            match field_ident.id {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv::O1(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv::O3(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(4) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetPartitionColumnStatisticsResultRecv::O4(
                                field_ident,
                            ),
                        );
                    } else {
