...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend {
    Ok(ColumnStatistics),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend::Ok(value) => {
                __protocol.write_struct_field(0, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend::O4(value) => {
            ...
            match field_ident.id {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend::O1(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend::O3(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(4) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetPartitionColumnStatisticsResultSend::O4(
                                field_ident,
                            ),
                        );
                    } else {
