...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionNamesResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartitionNamesResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetPartitionNamesResultRecv {
    Ok(::std::vec::Vec<::pilota::FastStr>),

    O2(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionNamesResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionNamesResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGetPartitionNamesResultRecv::Ok(value) => {
            ...
            ThriftHiveMetastoreGetPartitionNamesResultRecv::O2(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetPartitionNamesResultRecv::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetPartitionNamesResultRecv::O2(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetPartitionNamesResultRecv::Ok(value) => __protocol.list_field_len(
                Some(0),
                ::pilota::thrift::TType::Binary,
                value,
                |__protocol, el| __protocol.faststr_len(el),
