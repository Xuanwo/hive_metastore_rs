...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionNamesResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartitionNamesResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetPartitionNamesResultSend {
    Ok(::std::vec::Vec<::pilota::FastStr>),

    O2(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionNamesResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionNamesResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGetPartitionNamesResultSend::Ok(value) => {
            ...
            ThriftHiveMetastoreGetPartitionNamesResultSend::O2(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetPartitionNamesResultSend::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetPartitionNamesResultSend::O2(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetPartitionNamesResultSend::Ok(value) => __protocol.list_field_len(
                Some(0),
                ::pilota::thrift::TType::Binary,
                value,
                |__protocol, el| __protocol.faststr_len(el),
