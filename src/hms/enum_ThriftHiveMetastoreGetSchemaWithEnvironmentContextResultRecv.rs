...
impl ::std::default::Default for ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv::Ok(value) => {
            ...
            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv::O3(value) => {
            ...
            match field_ident.id {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(
                            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv::O1(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv::O3(
                                field_ident,
                            ),
                        );
                    } else {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultRecv::Ok(value) => __protocol
                .list_field_len(
                    Some(0),
                    ::pilota::thrift::TType::Struct,
                    value,
