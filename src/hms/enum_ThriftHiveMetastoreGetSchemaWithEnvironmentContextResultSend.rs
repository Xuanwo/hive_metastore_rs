...
impl ::std::default::Default for ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend {
    Ok(::std::vec::Vec<FieldSchema>),

    O1(MetaException),

    O2(UnknownTableException),

    O3(UnknownDbException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend::Ok(value) => {
            ...
            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend::O3(value) => {
            ...
            match field_ident.id {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(
                            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend::O1(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend::O3(
                                field_ident,
                            ),
                        );
                    } else {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetSchemaWithEnvironmentContextResultSend::Ok(value) => __protocol
                .list_field_len(
                    Some(0),
                    ::pilota::thrift::TType::Struct,
                    value,
