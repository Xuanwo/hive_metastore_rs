...
impl ::std::default::Default for ThriftHiveMetastoreGetTableMetaResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetTableMetaResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetTableMetaResultRecv {
    Ok(::std::vec::Vec<TableMeta>),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetTableMetaResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetTableMetaResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGetTableMetaResultRecv::Ok(value) => {
            ...
            ThriftHiveMetastoreGetTableMetaResultRecv::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        let field_ident = unsafe {
                            ...
                            let mut val: ::std::vec::Vec<TableMeta> =
                        ...
                        ret = Some(ThriftHiveMetastoreGetTableMetaResultRecv::Ok(field_ident));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetTableMetaResultRecv::O1(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                        ...
                        if ret.is_none() {
                            let field_ident = {
                                ...
                                for _ in 0..list_ident.size {
                                    val.push(
                                        <TableMeta as ::pilota::thrift::Message>::decode_async(
                                            __protocol,
                                        )
                                        .await?,
                                    );
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetTableMetaResultRecv::Ok(value) => __protocol.list_field_len(
                Some(0),
                ::pilota::thrift::TType::Struct,
                value,
                |__protocol, el| __protocol.struct_len(el),
