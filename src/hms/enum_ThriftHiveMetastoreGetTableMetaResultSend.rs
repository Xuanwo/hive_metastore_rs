...
impl ::std::default::Default for ThriftHiveMetastoreGetTableMetaResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGetTableMetaResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetTableMetaResultSend {
    Ok(::std::vec::Vec<TableMeta>),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetTableMetaResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetTableMetaResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGetTableMetaResultSend::Ok(value) => {
            ...
            ThriftHiveMetastoreGetTableMetaResultSend::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetTableMetaResultSend::Ok(field_ident));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetTableMetaResultSend::O1(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetTableMetaResultSend::Ok(value) => __protocol.list_field_len(
                Some(0),
                ::pilota::thrift::TType::Struct,
                value,
                |__protocol, el| __protocol.struct_len(el),
