...
impl ::std::default::Default for ThriftHiveMetastoreGetTableObjectsByNameException {
    fn default() -> Self {
        ThriftHiveMetastoreGetTableObjectsByNameException::O1(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetTableObjectsByNameException {
    O1(MetaException),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetTableObjectsByNameException {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetTableObjectsByNameException",
        })?;
        match self {
            ThriftHiveMetastoreGetTableObjectsByNameException::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetTableObjectsByNameException::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetTableObjectsByNameException::O3(value) => {
            ...
            match field_ident.id {
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetTableObjectsByNameException::O1(
                            field_ident,
                        ));
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreGetTableObjectsByNameException::O2(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(3) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreGetTableObjectsByNameException::O3(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
