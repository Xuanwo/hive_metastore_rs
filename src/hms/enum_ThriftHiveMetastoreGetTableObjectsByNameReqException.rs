...
impl ::std::default::Default for ThriftHiveMetastoreGetTableObjectsByNameReqException {
    fn default() -> Self {
        ThriftHiveMetastoreGetTableObjectsByNameReqException::O1(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetTableObjectsByNameReqException {
    O1(MetaException),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetTableObjectsByNameReqException {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetTableObjectsByNameReqException",
        })?;
        match self {
            ThriftHiveMetastoreGetTableObjectsByNameReqException::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetTableObjectsByNameReqException::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetTableObjectsByNameReqException::O3(value) => {
            ...
            match field_ident.id {
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetTableObjectsByNameReqException::O1(
                            field_ident,
                        ));
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreGetTableObjectsByNameReqException::O2(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(3) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreGetTableObjectsByNameReqException::O3(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
