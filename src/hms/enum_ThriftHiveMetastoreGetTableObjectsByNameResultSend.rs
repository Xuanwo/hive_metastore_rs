...
impl ::std::default::Default for ThriftHiveMetastoreGetTableObjectsByNameResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGetTableObjectsByNameResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetTableObjectsByNameResultSend {
    Ok(::std::vec::Vec<Table>),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetTableObjectsByNameResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetTableObjectsByNameResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGetTableObjectsByNameResultSend::Ok(value) => {
            ...
            ThriftHiveMetastoreGetTableObjectsByNameResultSend::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetTableObjectsByNameResultSend::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreGetTableObjectsByNameResultSend::O3(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetTableObjectsByNameResultSend::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetTableObjectsByNameResultSend::O1(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreGetTableObjectsByNameResultSend::O2(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(3) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreGetTableObjectsByNameResultSend::O3(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                        ...
                        if ret.is_none() {
                            let field_ident = {
                                ...
                                for _ in 0..list_ident.size {
                                    val.push(
                                        <Table as ::pilota::thrift::Message>::decode_async(
                                            __protocol,
                                        )
                                        .await?,
                                    );
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetTableObjectsByNameResultSend::Ok(value) => __protocol
                .list_field_len(
                    Some(0),
                    ::pilota::thrift::TType::Struct,
                    value,
