...
impl ::std::default::Default for ThriftHiveMetastoreGetTypeAllResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetTypeAllResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGetTypeAllResultRecv {
    Ok(::pilota::AHashMap<::pilota::FastStr, Type>),

    O2(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGetTypeAllResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetTypeAllResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGetTypeAllResultRecv::Ok(value) => {
            ...
            ThriftHiveMetastoreGetTypeAllResultRecv::O2(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetTypeAllResultRecv::Ok(field_ident));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGetTypeAllResultRecv::O2(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreGetTypeAllResultRecv::Ok(value) => __protocol.map_field_len(
                Some(0),
                ::pilota::thrift::TType::Binary,
                ::pilota::thrift::TType::Struct,
                value,
