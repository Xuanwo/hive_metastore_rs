...
impl ::std::default::Default for ThriftHiveMetastoreGrantPrivilegesResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGrantPrivilegesResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGrantPrivilegesResultRecv {
    Ok(bool),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGrantPrivilegesResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGrantPrivilegesResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreGrantPrivilegesResultRecv::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreGrantPrivilegesResultRecv::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGrantPrivilegesResultRecv::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGrantPrivilegesResultRecv::O1(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
