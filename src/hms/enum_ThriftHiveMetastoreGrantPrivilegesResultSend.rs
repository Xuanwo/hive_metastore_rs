...
impl ::std::default::Default for ThriftHiveMetastoreGrantPrivilegesResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGrantPrivilegesResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGrantPrivilegesResultSend {
    Ok(bool),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGrantPrivilegesResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGrantPrivilegesResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGrantPrivilegesResultSend::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreGrantPrivilegesResultSend::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGrantPrivilegesResultSend::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGrantPrivilegesResultSend::O1(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
