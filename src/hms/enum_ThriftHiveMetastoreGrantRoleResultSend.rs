...
impl ::std::default::Default for ThriftHiveMetastoreGrantRoleResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreGrantRoleResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreGrantRoleResultSend {
    Ok(bool),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreGrantRoleResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGrantRoleResultSend",
        })?;
        match self {
            ThriftHiveMetastoreGrantRoleResultSend::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreGrantRoleResultSend::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGrantRoleResultSend::Ok(field_ident));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreGrantRoleResultSend::O1(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
