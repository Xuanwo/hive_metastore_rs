...
impl ::std::default::Default for ThriftHiveMetastoreIsPartitionMarkedForEventException {
    fn default() -> Self {
        ThriftHiveMetastoreIsPartitionMarkedForEventException::O1(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreIsPartitionMarkedForEventException {
    O1(MetaException),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreIsPartitionMarkedForEventException {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreIsPartitionMarkedForEventException",
        })?;
        match self {
            ThriftHiveMetastoreIsPartitionMarkedForEventException::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventException::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventException::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventException::O4(value) => {
                __protocol.write_struct_field(4, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventException::O5(value) => {
                __protocol.write_struct_field(5, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventException::O6(value) => {
            ...
            match field_ident.id {
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventException::O1(
                            field_ident,
                        ));
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventException::O2(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(3) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventException::O3(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(4) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventException::O4(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(5) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventException::O5(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(6) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventException::O6(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
