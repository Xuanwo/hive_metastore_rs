...
impl ::std::default::Default for ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv {
    Ok(bool),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O4(value) => {
                __protocol.write_struct_field(4, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O5(value) => {
                __protocol.write_struct_field(5, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O6(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O1(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O2(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(3) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O3(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(4) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O4(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(5) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O5(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(6) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultRecv::O6(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
