...
impl ::std::default::Default for ThriftHiveMetastoreIsPartitionMarkedForEventResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreIsPartitionMarkedForEventResultSend {
    Ok(bool),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreIsPartitionMarkedForEventResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreIsPartitionMarkedForEventResultSend",
        })?;
        match self {
            ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O4(value) => {
                __protocol.write_struct_field(4, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O5(value) => {
                __protocol.write_struct_field(5, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O6(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O1(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(2) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O2(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(3) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O3(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(4) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O4(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(5) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O5(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
                ...
                Some(6) => {
                    if ret.is_none() {
                        let field_ident = ::pilota::thrift::Message::decode(__protocol)?;
                        __protocol.struct_len(&field_ident);
                        ret = Some(ThriftHiveMetastoreIsPartitionMarkedForEventResultSend::O6(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
