...
impl ::std::default::Default for ThriftHiveMetastoreListRolesResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreListRolesResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreListRolesResultRecv {
    Ok(::std::vec::Vec<Role>),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreListRolesResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreListRolesResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreListRolesResultRecv::Ok(value) => {
            ...
            ThriftHiveMetastoreListRolesResultRecv::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreListRolesResultRecv::Ok(field_ident));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreListRolesResultRecv::O1(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastoreListRolesResultRecv::Ok(value) => __protocol.list_field_len(
                Some(0),
                ::pilota::thrift::TType::Struct,
                value,
                |__protocol, el| __protocol.struct_len(el),
