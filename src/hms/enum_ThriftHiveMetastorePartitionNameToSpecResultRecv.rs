...
impl ::std::default::Default for ThriftHiveMetastorePartitionNameToSpecResultRecv {
    fn default() -> Self {
        ThriftHiveMetastorePartitionNameToSpecResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastorePartitionNameToSpecResultRecv {
    Ok(::pilota::AHashMap<::pilota::FastStr, ::pilota::FastStr>),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastorePartitionNameToSpecResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastorePartitionNameToSpecResultRecv",
        })?;
        match self {
            ThriftHiveMetastorePartitionNameToSpecResultRecv::Ok(value) => {
            ...
            ThriftHiveMetastorePartitionNameToSpecResultRecv::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastorePartitionNameToSpecResultRecv::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastorePartitionNameToSpecResultRecv::O1(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastorePartitionNameToSpecResultRecv::Ok(value) => __protocol
                .map_field_len(
                    Some(0),
                    ::pilota::thrift::TType::Binary,
                    ::pilota::thrift::TType::Binary,
