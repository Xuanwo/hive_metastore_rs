...
impl ::std::default::Default for ThriftHiveMetastorePartitionNameToSpecResultSend {
    fn default() -> Self {
        ThriftHiveMetastorePartitionNameToSpecResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastorePartitionNameToSpecResultSend {
    Ok(::pilota::AHashMap<::pilota::FastStr, ::pilota::FastStr>),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastorePartitionNameToSpecResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastorePartitionNameToSpecResultSend",
        })?;
        match self {
            ThriftHiveMetastorePartitionNameToSpecResultSend::Ok(value) => {
            ...
            ThriftHiveMetastorePartitionNameToSpecResultSend::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastorePartitionNameToSpecResultSend::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastorePartitionNameToSpecResultSend::O1(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastorePartitionNameToSpecResultSend::Ok(value) => __protocol
                .map_field_len(
                    Some(0),
                    ::pilota::thrift::TType::Binary,
                    ::pilota::thrift::TType::Binary,
