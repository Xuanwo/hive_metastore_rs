...
impl ::std::default::Default for ThriftHiveMetastorePartitionNameToValsResultSend {
    fn default() -> Self {
        ThriftHiveMetastorePartitionNameToValsResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastorePartitionNameToValsResultSend {
    Ok(::std::vec::Vec<::pilota::FastStr>),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastorePartitionNameToValsResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastorePartitionNameToValsResultSend",
        })?;
        match self {
            ThriftHiveMetastorePartitionNameToValsResultSend::Ok(value) => {
            ...
            ThriftHiveMetastorePartitionNameToValsResultSend::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastorePartitionNameToValsResultSend::Ok(
                            field_ident,
                        ));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastorePartitionNameToValsResultSend::O1(
                            field_ident,
                        ));
                    } else {
                        return ::std::result::Result::Err(
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            ThriftHiveMetastorePartitionNameToValsResultSend::Ok(value) => __protocol
                .list_field_len(
                    Some(0),
                    ::pilota::thrift::TType::Binary,
                    value,
