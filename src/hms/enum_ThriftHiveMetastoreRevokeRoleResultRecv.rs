...
impl ::std::default::Default for ThriftHiveMetastoreRevokeRoleResultRecv {
    fn default() -> Self {
        ThriftHiveMetastoreRevokeRoleResultRecv::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreRevokeRoleResultRecv {
    Ok(bool),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreRevokeRoleResultRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreRevokeRoleResultRecv",
        })?;
        match self {
            ThriftHiveMetastoreRevokeRoleResultRecv::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreRevokeRoleResultRecv::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreRevokeRoleResultRecv::Ok(field_ident));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreRevokeRoleResultRecv::O1(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
