...
impl ::std::default::Default for ThriftHiveMetastoreRevokeRoleResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreRevokeRoleResultSend::Ok(::std::default::Default::default())
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreRevokeRoleResultSend {
    Ok(bool),

    O1(MetaException),
}

impl ::pilota::thrift::Message for ThriftHiveMetastoreRevokeRoleResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreRevokeRoleResultSend",
        })?;
        match self {
            ThriftHiveMetastoreRevokeRoleResultSend::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreRevokeRoleResultSend::O1(value) => {
            ...
            match field_ident.id {
                Some(0) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreRevokeRoleResultSend::Ok(field_ident));
                    } else {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(ThriftHiveMetastoreRevokeRoleResultSend::O1(field_ident));
                    } else {
                        return ::std::result::Result::Err(
                            ::pilota::thrift::new_protocol_exception(
                                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
