...
impl ::std::default::Default for ThriftHiveMetastoreUpdatePartitionColumnStatisticsException {
    fn default() -> Self {
        ThriftHiveMetastoreUpdatePartitionColumnStatisticsException::O1(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreUpdatePartitionColumnStatisticsException {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreUpdatePartitionColumnStatisticsException {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreUpdatePartitionColumnStatisticsException",
        })?;
        match self {
            ThriftHiveMetastoreUpdatePartitionColumnStatisticsException::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreUpdatePartitionColumnStatisticsException::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreUpdatePartitionColumnStatisticsException::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreUpdatePartitionColumnStatisticsException::O4(value) => {
            ...
            match field_ident.id {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreUpdatePartitionColumnStatisticsException::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreUpdatePartitionColumnStatisticsException::O3(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(4) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreUpdatePartitionColumnStatisticsException::O4(
                                field_ident,
                            ),
                        );
                    } else {
