...
impl ::std::default::Default for ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend {
    fn default() -> Self {
        ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend::Ok(
            ::std::default::Default::default(),
        )
    }
}
#[derive(PartialOrd, Hash, Eq, Ord, Debug, Clone, PartialEq)]
pub enum ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend {
    Ok(bool),
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_begin(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend",
        })?;
        match self {
            ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend::Ok(value) => {
                __protocol.write_bool_field(0, *value)?;
            }
            ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend::O1(value) => {
                __protocol.write_struct_field(1, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend::O2(value) => {
                __protocol.write_struct_field(2, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend::O3(value) => {
                __protocol.write_struct_field(3, value, ::pilota::thrift::TType::Struct)?;
            }
            ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend::O4(value) => {
            ...
            match field_ident.id {
                ...
                Some(1) => {
                    if ret.is_none() {
                        ...
                        ret = Some(
                            ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend::O1(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(2) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend::O2(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(3) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend::O3(
                                field_ident,
                            ),
                        );
                    } else {
                ...
                Some(4) => {
                    if ret.is_none() {
                        ...
                        __protocol.struct_len(&field_ident);
                        ret = Some(
                            ThriftHiveMetastoreUpdateTableColumnStatisticsResultSend::O4(
                                field_ident,
                            ),
                        );
                    } else {
