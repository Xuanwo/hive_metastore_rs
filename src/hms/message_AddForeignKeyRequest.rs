...
pub struct AddForeignKeyRequest {
    pub foreign_key_cols: ::std::vec::Vec<SqlForeignKey>,
}
impl ::pilota::thrift::Message for AddForeignKeyRequest {
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `AddForeignKeyRequest` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let Some(var_1) = var_1 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ...
                "field foreign_key_cols is required".to_string(),
            ));
        };

        let data = Self {
            foreign_key_cols: var_1,
        };
