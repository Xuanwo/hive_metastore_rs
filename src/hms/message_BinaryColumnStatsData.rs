...
impl ::pilota::thrift::Message for BinaryColumnStatsData {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_i64_field(1, *&self.max_col_len)?;
        __protocol.write_double_field(2, *&self.avg_col_len)?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            loop {
                ...
                match field_ident.id {
                    ...
                    Some(2) if field_ident.field_type == ::pilota::thrift::TType::Double => {
                        var_2 = Some(__protocol.read_double()?);
                    }
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `BinaryColumnStatsData` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let Some(var_1) = var_1 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ...
                "field max_col_len is required".to_string(),
            ));
        };
        let Some(var_2) = var_2 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field avg_col_len is required".to_string(),
            ));
        };
            ...
            if let ::std::result::Result::Err(mut err) = async {
                loop {
                    ...
                    match field_ident.id {
                        ...
                        Some(2) if field_ident.field_type == ::pilota::thrift::TType::Double => {
                            var_2 = Some(__protocol.read_double().await?);
                        }
                        Some(3) if field_ident.field_type == ::pilota::thrift::TType::I64 => {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            name: "BinaryColumnStatsData",
        }) + __protocol.i64_field_len(Some(1), *&self.max_col_len)
            + __protocol.double_field_len(Some(2), *&self.avg_col_len)
