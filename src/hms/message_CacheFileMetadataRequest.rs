...
pub struct CacheFileMetadataRequest {
    ...
    pub is_all_parts: ::std::option::Option<bool>,
}
impl ::pilota::thrift::Message for CacheFileMetadataRequest {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.is_all_parts.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `CacheFileMetadataRequest` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
