...
pub struct ColumnStatistics {
    ...
    pub stats_obj: ::std::vec::Vec<ColumnStatisticsObj>,
}
impl ::pilota::thrift::Message for ColumnStatistics {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_struct_field(1, &self.stats_desc, ::pilota::thrift::TType::Struct)?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
                ...
                match field_ident.id {
                    ...
                    Some(2) if field_ident.field_type == ::pilota::thrift::TType::List => {
                        var_2 = Some(unsafe {
                            ...
                            let mut val: ::std::vec::Vec<ColumnStatisticsObj> =
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `ColumnStatistics` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let Some(var_1) = var_1 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ...
                "field stats_desc is required".to_string(),
            ));
        };
        let Some(var_2) = var_2 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field stats_obj is required".to_string(),
            ));
        };
    ...
    > {
        ::std::boxed::Box::pin(async move {
            ...
            if let ::std::result::Result::Err(mut err) = async {
                ...
                match field_ident.id {
                    Some(1) if field_ident.field_type == ::pilota::thrift::TType::Struct  => {
                    var_1 = Some(<ColumnStatisticsDesc as ::pilota::thrift::Message>::decode_async(__protocol).await?);
                    ...
                    var_2 = Some({
                            ...
                            for _ in 0..list_ident.size {
                                val.push(<ColumnStatisticsObj as ::pilota::thrift::Message>::decode_async(__protocol).await?);
                            };
                ...
                if let Some(field_id) = __pilota_decoding_field_id {
                    err.prepend_msg(&format!("decode struct `ColumnStatistics` field(#{}) failed, caused by: ", field_id));
                }
                return ::std::result::Result::Err(err);
            };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            name: "ColumnStatistics",
        }) + __protocol.struct_field_len(Some(1), &self.stats_desc)
