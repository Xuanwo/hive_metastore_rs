...
pub struct CompactionRequest {
    ...
    pub runas: ::std::option::Option<::pilota::FastStr>,

    pub properties: ::std::option::Option<::pilota::AHashMap<::pilota::FastStr, ::pilota::FastStr>>,
}
impl ::pilota::thrift::Message for CompactionRequest {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.runas.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `CompactionRequest` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + self.properties.as_ref().map_or(0, |value| {
