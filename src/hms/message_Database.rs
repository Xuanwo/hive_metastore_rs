...
pub struct Database {
    ...
    pub description: ::std::option::Option<::pilota::FastStr>,

    pub location_uri: ::std::option::Option<::pilota::FastStr>,
    ...
    pub catalog_name: ::std::option::Option<::pilota::FastStr>,
}
impl ::pilota::thrift::Message for Database {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier { name: "Database" };
        ...
        if let Some(value) = self.location_uri.as_ref() {
        ...
        if let Some(value) = self.catalog_name.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `Database` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier { name: "Database" })
            + self
                .name
                .as_ref()
