...
pub struct DateColumnStatsData {
    pub low_value: ::std::option::Option<Date>,

    pub high_value: ::std::option::Option<Date>,
...
impl ::pilota::thrift::Message for DateColumnStatsData {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `DateColumnStatsData` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
            ...
            if let ::std::result::Result::Err(mut err) = async {
                loop {
                    ...
                    match field_ident.id {
                        Some(1) if field_ident.field_type == ::pilota::thrift::TType::Struct => {
                            var_1 = Some(
                                <Date as ::pilota::thrift::Message>::decode_async(__protocol)
                                    .await?,
                            );
                        }
                        Some(2) if field_ident.field_type == ::pilota::thrift::TType::Struct => {
