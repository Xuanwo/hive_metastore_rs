...
pub struct DoubleColumnStatsData {
    pub low_value: ::std::option::Option<f64>,

    pub high_value: ::std::option::Option<f64>,
...
impl ::pilota::thrift::Message for DoubleColumnStatsData {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.low_value.as_ref() {
            __protocol.write_double_field(1, *value)?;
        }
        if let Some(value) = self.high_value.as_ref() {
            __protocol.write_double_field(2, *value)?;
        }
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `DoubleColumnStatsData` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            .low_value
            .as_ref()
            .map_or(0, |value| __protocol.double_field_len(Some(1), *value))
            + self
                .high_value
                .as_ref()
                .map_or(0, |value| __protocol.double_field_len(Some(2), *value))
