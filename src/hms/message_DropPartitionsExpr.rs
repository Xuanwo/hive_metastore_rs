...
pub struct DropPartitionsExpr {
    ...
    pub part_archive_level: ::std::option::Option<i32>,
}
impl ::pilota::thrift::Message for DropPartitionsExpr {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_bytes_field(1, (&self.expr).clone())?;
        if let Some(value) = self.part_archive_level.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `DropPartitionsExpr` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            name: "DropPartitionsExpr",
        }) + __protocol.bytes_field_len(Some(1), &self.expr)
            + self
                .part_archive_level
                .as_ref()
