...
pub struct ForeignKeysRequest {
    pub parent_db_name: ::std::option::Option<::pilota::FastStr>,

    pub parent_tbl_name: ::std::option::Option<::pilota::FastStr>,

    pub foreign_db_name: ::std::option::Option<::pilota::FastStr>,

    pub foreign_tbl_name: ::std::option::Option<::pilota::FastStr>,
}
impl ::pilota::thrift::Message for ForeignKeysRequest {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.parent_db_name.as_ref() {
            __protocol.write_faststr_field(1, (value).clone())?;
        }
        if let Some(value) = self.parent_tbl_name.as_ref() {
            __protocol.write_faststr_field(2, (value).clone())?;
        }
        if let Some(value) = self.foreign_db_name.as_ref() {
            __protocol.write_faststr_field(3, (value).clone())?;
        }
        if let Some(value) = self.foreign_tbl_name.as_ref() {
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `ForeignKeysRequest` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let data = Self {
            parent_db_name: var_1,
            parent_tbl_name: var_2,
            foreign_db_name: var_3,
            foreign_tbl_name: var_4,
        };
