...
pub struct GetAllFunctionsResponse {
    pub functions: ::std::option::Option<::std::vec::Vec<Function>>,
}
impl ::pilota::thrift::Message for GetAllFunctionsResponse {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.functions.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
                ...
                match field_ident.id {
                    Some(1) if field_ident.field_type == ::pilota::thrift::TType::List => {
                        var_1 = Some(unsafe {
                            ...
                            let mut val: ::std::vec::Vec<Function> =
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `GetAllFunctionsResponse` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
                        ...
                        Some(1) if field_ident.field_type == ::pilota::thrift::TType::List => {
                            var_1 = Some({
                                ...
                                for _ in 0..list_ident.size {
                                    val.push(
                                        <Function as ::pilota::thrift::Message>::decode_async(
                                            __protocol,
                                        )
                                        .await?,
                                    );
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            name: "GetAllFunctionsResponse",
        }) + self.functions.as_ref().map_or(0, |value| {
