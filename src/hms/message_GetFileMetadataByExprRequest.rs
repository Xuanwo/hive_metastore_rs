...
pub struct GetFileMetadataByExprRequest {
    ...
    pub do_get_footers: ::std::option::Option<bool>,

    pub r#type: ::std::option::Option<FileMetadataExprType>,
}
impl ::pilota::thrift::Message for GetFileMetadataByExprRequest {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_bytes_field(2, (&self.expr).clone())?;
        if let Some(value) = self.do_get_footers.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            loop {
                ...
                match field_ident.id {
                    ...
                    Some(2) if field_ident.field_type == ::pilota::thrift::TType::Binary => {
                        var_2 = Some(__protocol.read_bytes()?);
                    }
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `GetFileMetadataByExprRequest` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
    ...
    > {
        ::std::boxed::Box::pin(async move {
            ...
            if let ::std::result::Result::Err(mut err) = async {
                loop {
                    ...
                    match field_ident.id {
                        ...
                        Some(2) if field_ident.field_type == ::pilota::thrift::TType::Binary => {
                            var_2 = Some(__protocol.read_bytes().await?);
                        }
                        Some(3) if field_ident.field_type == ::pilota::thrift::TType::Bool => {
            ...
            {
                if let Some(field_id) = __pilota_decoding_field_id {
                    err.prepend_msg(&format!("decode struct `GetFileMetadataByExprRequest` field(#{}) failed, caused by: ", field_id));
                }
                return ::std::result::Result::Err(err);
            };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        ) + __protocol.bytes_field_len(Some(2), &self.expr)
            + self
                .do_get_footers
                .as_ref()
