...
pub struct GetOpenTxnsInfoResponse {
    ...
    pub open_txns: ::std::vec::Vec<TxnInfo>,
}
impl ::pilota::thrift::Message for GetOpenTxnsInfoResponse {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
                ...
                match field_ident.id {
                    ...
                    Some(2) if field_ident.field_type == ::pilota::thrift::TType::List => {
                        var_2 = Some(unsafe {
                            ...
                            let mut val: ::std::vec::Vec<TxnInfo> =
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `GetOpenTxnsInfoResponse` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
                        ...
                        Some(2) if field_ident.field_type == ::pilota::thrift::TType::List => {
                            var_2 = Some({
                                ...
                                for _ in 0..list_ident.size {
                                    val.push(
                                        <TxnInfo as ::pilota::thrift::Message>::decode_async(
                                            __protocol,
                                        )
                                        .await?,
                                    );
