...
pub struct GetOpenTxnsResponse {
    ...
    pub open_txns: ::pilota::AHashSet<i64>,

    pub min_open_txn: ::std::option::Option<i64>,
}
impl ::pilota::thrift::Message for GetOpenTxnsResponse {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_i64_field(1, *&self.txn_high_water_mark)?;
        ...
        if let Some(value) = self.min_open_txn.as_ref() {
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
                    ...
                    Some(2) if field_ident.field_type == ::pilota::thrift::TType::Set => {
                        var_2 = Some({
                            ...
                            for _ in 0..list_ident.size {
                                val.insert(__protocol.read_i64()?);
                            }
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `GetOpenTxnsResponse` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let Some(var_1) = var_1 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ...
                "field txn_high_water_mark is required".to_string(),
            ));
        };
        let Some(var_2) = var_2 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field open_txns is required".to_string(),
            ));
        };

        let data = Self {
            txn_high_water_mark: var_1,
            open_txns: var_2,
            min_open_txn: var_3,
        };
                    ...
                    match field_ident.id {
                        ...
                        Some(2) if field_ident.field_type == ::pilota::thrift::TType::Set => {
                            var_2 = Some({
                                ...
                                let mut val = ::pilota::AHashSet::with_capacity(list_ident.size);
                                for _ in 0..list_ident.size {
                                    val.insert(__protocol.read_i64().await?);
                                }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            name: "GetOpenTxnsResponse",
        }) + __protocol.i64_field_len(Some(1), *&self.txn_high_water_mark)
