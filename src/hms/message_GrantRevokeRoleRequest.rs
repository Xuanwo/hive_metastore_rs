...
pub struct GrantRevokeRoleRequest {
    ...
    pub grantor: ::std::option::Option<::pilota::FastStr>,

    pub grantor_type: ::std::option::Option<PrincipalType>,

    pub grant_option: ::std::option::Option<bool>,
}
impl ::pilota::thrift::Message for GrantRevokeRoleRequest {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.grantor.as_ref() {
            __protocol.write_faststr_field(5, (value).clone())?;
        }
        if let Some(value) = self.grantor_type.as_ref() {
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `GrantRevokeRoleRequest` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let data = Self {
            request_type: var_1,
            role_name: var_2,
            principal_name: var_3,
            principal_type: var_4,
            grantor: var_5,
            grantor_type: var_6,
            grant_option: var_7,
        };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + self.grantor_type.as_ref().map_or(0, |value| {
