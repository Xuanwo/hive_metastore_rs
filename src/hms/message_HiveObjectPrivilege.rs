...
pub struct HiveObjectPrivilege {
    pub hive_object: ::std::option::Option<HiveObjectRef>,

    pub principal_name: ::std::option::Option<::pilota::FastStr>,

    pub principal_type: ::std::option::Option<PrincipalType>,

    pub grant_info: ::std::option::Option<PrivilegeGrantInfo>,
}
impl ::pilota::thrift::Message for HiveObjectPrivilege {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.hive_object.as_ref() {
        ...
        if let Some(value) = self.grant_info.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `HiveObjectPrivilege` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
            ...
            if let ::std::result::Result::Err(mut err) = async {
                loop {
                    ...
                    match field_ident.id {
                        ...
                        Some(4) if field_ident.field_type == ::pilota::thrift::TType::Struct => {
                            var_4 = Some(
                                <PrivilegeGrantInfo as ::pilota::thrift::Message>::decode_async(
                                    __protocol,
                                )
                                .await?,
                            );
