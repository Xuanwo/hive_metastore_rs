...
pub struct HiveObjectRef {
    pub object_type: ::std::option::Option<HiveObjectType>,

    pub db_name: ::std::option::Option<::pilota::FastStr>,

    pub object_name: ::std::option::Option<::pilota::FastStr>,

    pub part_values: ::std::option::Option<::std::vec::Vec<::pilota::FastStr>>,

    pub column_name: ::std::option::Option<::pilota::FastStr>,

    pub cat_name: ::std::option::Option<::pilota::FastStr>,
}
impl ::pilota::thrift::Message for HiveObjectRef {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.object_type.as_ref() {
        ...
        if let Some(value) = self.object_name.as_ref() {
            __protocol.write_faststr_field(3, (value).clone())?;
        }
        if let Some(value) = self.part_values.as_ref() {
