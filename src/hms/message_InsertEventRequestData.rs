...
pub struct InsertEventRequestData {
    pub files_added: ::std::vec::Vec<::pilota::FastStr>,

    pub files_added_checksum: ::std::option::Option<::std::vec::Vec<::pilota::FastStr>>,
}
impl ::pilota::thrift::Message for InsertEventRequestData {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.files_added_checksum.as_ref() {
            __protocol.write_list_field(
                2,
                ::pilota::thrift::TType::Binary,
                &value,
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `InsertEventRequestData` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let Some(var_1) = var_1 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ...
                "field files_added is required".to_string(),
            ));
        };

        let data = Self {
            files_added: var_1,
            files_added_checksum: var_2,
        };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        ) + self.files_added_checksum.as_ref().map_or(0, |value| {
            __protocol.list_field_len(
                Some(2),
                ::pilota::thrift::TType::Binary,
                value,
