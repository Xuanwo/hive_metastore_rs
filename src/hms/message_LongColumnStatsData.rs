...
pub struct LongColumnStatsData {
    pub low_value: ::std::option::Option<i64>,

    pub high_value: ::std::option::Option<i64>,
...
impl ::pilota::thrift::Message for LongColumnStatsData {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.low_value.as_ref() {
            __protocol.write_i64_field(1, *value)?;
        }
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `LongColumnStatsData` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            .low_value
            .as_ref()
            .map_or(0, |value| __protocol.i64_field_len(Some(1), *value))
            + self
                .high_value
                .as_ref()
