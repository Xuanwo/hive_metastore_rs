...
pub struct NotificationEventResponse {
    pub events: ::std::vec::Vec<NotificationEvent>,
}
impl ::pilota::thrift::Message for NotificationEventResponse {
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
                ...
                match field_ident.id {
                    Some(1) if field_ident.field_type == ::pilota::thrift::TType::List => {
                        var_1 = Some(unsafe {
                            ...
                            let mut val: ::std::vec::Vec<NotificationEvent> =
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `NotificationEventResponse` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let Some(var_1) = var_1 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ...
                "field events is required".to_string(),
            ));
        };

        let data = Self { events: var_1 };
    ...
    > {
        ::std::boxed::Box::pin(async move {
            ...
            if let ::std::result::Result::Err(mut err) = async {
                ...
                match field_ident.id {
                    ...
                    var_1 = Some({
                            ...
                            for _ in 0..list_ident.size {
                                val.push(<NotificationEvent as ::pilota::thrift::Message>::decode_async(__protocol).await?);
                            };
                ...
                if let Some(field_id) = __pilota_decoding_field_id {
                    err.prepend_msg(&format!("decode struct `NotificationEventResponse` field(#{}) failed, caused by: ", field_id));
                }
                return ::std::result::Result::Err(err);
            };
