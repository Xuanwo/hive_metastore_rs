...
impl ::std::default::Default for OpenTxnRequest {
    fn default() -> Self {
        OpenTxnRequest {
            num_txns: ::std::default::Default::default(),
...
impl ::pilota::thrift::Message for OpenTxnRequest {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_i32_field(1, *&self.num_txns)?;
        __protocol.write_faststr_field(2, (&self.user).clone())?;
        __protocol.write_faststr_field(3, (&self.hostname).clone())?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        let mut var_2 = None;
        let mut var_3 = None;
        let mut var_4 = Some(::pilota::FastStr::from_static_str("Unknown"));
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `OpenTxnRequest` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let Some(var_1) = var_1 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ...
                "field num_txns is required".to_string(),
            ));
        };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            name: "OpenTxnRequest",
        }) + __protocol.i32_field_len(Some(1), *&self.num_txns)
            + __protocol.faststr_field_len(Some(2), &self.user)
            + __protocol.faststr_field_len(Some(3), &self.hostname)
            + self
                .agent_info
                .as_ref()
