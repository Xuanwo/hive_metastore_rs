...
pub struct PartitionListComposingSpec {
    pub partitions: ::std::option::Option<::std::vec::Vec<Partition>>,
}
impl ::pilota::thrift::Message for PartitionListComposingSpec {
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `PartitionListComposingSpec` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let data = Self { partitions: var_1 };
