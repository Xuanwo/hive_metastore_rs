...
pub struct PartitionSpecWithSharedSd {
    pub partitions: ::std::option::Option<::std::vec::Vec<PartitionWithoutSd>>,

    pub sd: ::std::option::Option<StorageDescriptor>,
}
impl ::pilota::thrift::Message for PartitionSpecWithSharedSd {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.partitions.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
                ...
                match field_ident.id {
                    Some(1) if field_ident.field_type == ::pilota::thrift::TType::List => {
                        var_1 = Some(unsafe {
                            ...
                            let mut val: ::std::vec::Vec<PartitionWithoutSd> =
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `PartitionSpecWithSharedSd` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
    ...
    > {
        ::std::boxed::Box::pin(async move {
            ...
            if let ::std::result::Result::Err(mut err) = async {
                ...
                match field_ident.id {
                    ...
                    var_1 = Some({
                            ...
                            for _ in 0..list_ident.size {
                                val.push(<PartitionWithoutSd as ::pilota::thrift::Message>::decode_async(__protocol).await?);
                            };
                    ...
                    var_2 = Some(<StorageDescriptor as ::pilota::thrift::Message>::decode_async(__protocol).await?);
                ...
                if let Some(field_id) = __pilota_decoding_field_id {
                    err.prepend_msg(&format!("decode struct `PartitionSpecWithSharedSd` field(#{}) failed, caused by: ", field_id));
                }
                return ::std::result::Result::Err(err);
            };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            name: "PartitionSpecWithSharedSd",
        }) + self.partitions.as_ref().map_or(0, |value| {
