...
impl ::std::default::Default for PartitionsByExprRequest {
    fn default() -> Self {
        PartitionsByExprRequest {
            ...
            default_partition_name: ::std::default::Default::default(),
            max_parts: Some(-1i16),
...
pub struct PartitionsByExprRequest {
    ...
    pub expr: ::pilota::Bytes,

    pub default_partition_name: ::std::option::Option<::pilota::FastStr>,

    pub max_parts: ::std::option::Option<i16>,

    pub cat_name: ::std::option::Option<::pilota::FastStr>,
}
impl ::pilota::thrift::Message for PartitionsByExprRequest {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        __protocol.write_bytes_field(3, (&self.expr).clone())?;
        if let Some(value) = self.default_partition_name.as_ref() {
            __protocol.write_faststr_field(4, (value).clone())?;
        }
        if let Some(value) = self.max_parts.as_ref() {
            __protocol.write_i16_field(5, *value)?;
        }
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            loop {
                ...
                match field_ident.id {
                    ...
                    Some(3) if field_ident.field_type == ::pilota::thrift::TType::Binary => {
                        var_3 = Some(__protocol.read_bytes()?);
                    }
                    Some(4) if field_ident.field_type == ::pilota::thrift::TType::Binary => {
                        var_4 = Some(__protocol.read_faststr()?);
                    }
                    Some(5) if field_ident.field_type == ::pilota::thrift::TType::I16 => {
                        var_5 = Some(__protocol.read_i16()?);
                    }
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `PartitionsByExprRequest` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let Some(var_3) = var_3 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field expr is required".to_string(),
            ));
        };
            ...
            if let ::std::result::Result::Err(mut err) = async {
                loop {
                    ...
                    match field_ident.id {
                        ...
                        Some(3) if field_ident.field_type == ::pilota::thrift::TType::Binary => {
                            var_3 = Some(__protocol.read_bytes().await?);
                        }
                        Some(4) if field_ident.field_type == ::pilota::thrift::TType::Binary => {
                            var_4 = Some(__protocol.read_faststr().await?);
                        }
                        Some(5) if field_ident.field_type == ::pilota::thrift::TType::I16 => {
                            var_5 = Some(__protocol.read_i16().await?);
                        }
                        Some(6) if field_ident.field_type == ::pilota::thrift::TType::Binary => {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.bytes_field_len(Some(3), &self.expr)
            + self
            ...
            + self
                .max_parts
                .as_ref()
                .map_or(0, |value| __protocol.i16_field_len(Some(5), *value))
            + self
                .cat_name
                .as_ref()
