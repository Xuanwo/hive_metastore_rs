...
pub struct PartitionsStatsResult {
    pub part_stats: ::pilota::AHashMap<::pilota::FastStr, ::std::vec::Vec<ColumnStatisticsObj>>,
}
impl ::pilota::thrift::Message for PartitionsStatsResult {
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `PartitionsStatsResult` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
        ...
        let Some(var_1) = var_1 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ...
                "field part_stats is required".to_string(),
            ));
        };

        let data = Self { part_stats: var_1 };
    ...
    > {
        ::std::boxed::Box::pin(async move {
            ...
            if let ::std::result::Result::Err(mut err) = async {
                ...
                if let Some(field_id) = __pilota_decoding_field_id {
                    err.prepend_msg(&format!("decode struct `PartitionsStatsResult` field(#{}) failed, caused by: ", field_id));
                }
                return ::std::result::Result::Err(err);
            };
