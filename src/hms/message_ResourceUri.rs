...
pub struct ResourceUri {
    pub resource_type: ::std::option::Option<ResourceType>,

    pub uri: ::std::option::Option<::pilota::FastStr>,
}
impl ::pilota::thrift::Message for ResourceUri {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.resource_type.as_ref() {
            __protocol.write_i32_field(1, (value).inner())?;
        }
        if let Some(value) = self.uri.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `ResourceUri` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
            ...
            if let ::std::result::Result::Err(mut err) = async {
                loop {
                    ...
                    match field_ident.id {
                        Some(1) if field_ident.field_type == ::pilota::thrift::TType::I32 => {
                            var_1 = Some(
                                <ResourceType as ::pilota::thrift::Message>::decode_async(
                                    __protocol,
                                )
                                .await?,
                            );
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            name: "ResourceUri",
        }) + self.resource_type.as_ref().map_or(0, |value| {
