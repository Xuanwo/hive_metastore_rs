...
pub struct SetPartitionsStatsRequest {
    pub col_stats: ::std::vec::Vec<ColumnStatistics>,

    pub need_merge: ::std::option::Option<bool>,
}
impl ::pilota::thrift::Message for SetPartitionsStatsRequest {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.need_merge.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
                ...
                match field_ident.id {
                    Some(1) if field_ident.field_type == ::pilota::thrift::TType::List => {
                        var_1 = Some(unsafe {
                            ...
                            let mut val: ::std::vec::Vec<ColumnStatistics> =
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `SetPartitionsStatsRequest` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
    ...
    > {
        ::std::boxed::Box::pin(async move {
            ...
            if let ::std::result::Result::Err(mut err) = async {
                ...
                match field_ident.id {
                    ...
                    var_1 = Some({
                            ...
                            for _ in 0..list_ident.size {
                                val.push(<ColumnStatistics as ::pilota::thrift::Message>::decode_async(__protocol).await?);
                            };
                ...
                if let Some(field_id) = __pilota_decoding_field_id {
                    err.prepend_msg(&format!("decode struct `SetPartitionsStatsRequest` field(#{}) failed, caused by: ", field_id));
                }
                return ::std::result::Result::Err(err);
            };
