...
impl ::std::default::Default for ShowLocksRequest {
    fn default() -> Self {
        ShowLocksRequest {
...
pub struct ShowLocksRequest {
    pub dbname: ::std::option::Option<::pilota::FastStr>,

    pub tablename: ::std::option::Option<::pilota::FastStr>,

    pub partname: ::std::option::Option<::pilota::FastStr>,

    pub is_extended: ::std::option::Option<bool>,
}
impl ::pilota::thrift::Message for ShowLocksRequest {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.dbname.as_ref() {
        ...
        if let Some(value) = self.is_extended.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `ShowLocksRequest` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
