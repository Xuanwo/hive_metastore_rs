...
pub struct ShowLocksResponse {
    pub locks: ::std::option::Option<::std::vec::Vec<ShowLocksResponseElement>>,
}
impl ::pilota::thrift::Message for ShowLocksResponse {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        if let Some(value) = self.locks.as_ref() {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
                ...
                match field_ident.id {
                    Some(1) if field_ident.field_type == ::pilota::thrift::TType::List => {
                        var_1 = Some(unsafe {
                            ...
                            let mut val: ::std::vec::Vec<ShowLocksResponseElement> =
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `ShowLocksResponse` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
    ...
    > {
        ::std::boxed::Box::pin(async move {
            ...
            if let ::std::result::Result::Err(mut err) = async {
                ...
                match field_ident.id {
                    ...
                    var_1 = Some({
                            ...
                            for _ in 0..list_ident.size {
                                val.push(<ShowLocksResponseElement as ::pilota::thrift::Message>::decode_async(__protocol).await?);
                            };
                ...
                if let Some(field_id) = __pilota_decoding_field_id {
                    err.prepend_msg(&format!("decode struct `ShowLocksResponse` field(#{}) failed, caused by: ", field_id));
                }
                return ::std::result::Result::Err(err);
            };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            name: "ShowLocksResponse",
        }) + self.locks.as_ref().map_or(0, |value| {
