...
pub struct ThriftHiveMetastoreAlterPartitionsWithEnvironmentContextArgsRecv {
    pub db_name: ::pilota::FastStr,

    pub tbl_name: ::pilota::FastStr,

    pub new_parts: ::std::vec::Vec<Partition>,

    pub environment_context: EnvironmentContext,
}
impl ::pilota::thrift::Message
    for ThriftHiveMetastoreAlterPartitionsWithEnvironmentContextArgsRecv
{
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreAlterPartitionsWithEnvironmentContextArgsRecv",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreAlterPartitionsWithEnvironmentContextArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
        ...
        let Some(var_3) = var_3 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field new_parts is required".to_string(),
            ));
        };
