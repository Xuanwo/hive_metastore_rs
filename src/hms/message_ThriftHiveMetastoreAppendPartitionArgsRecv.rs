...
pub struct ThriftHiveMetastoreAppendPartitionArgsRecv {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreAppendPartitionArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreAppendPartitionArgsRecv",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreAppendPartitionArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
