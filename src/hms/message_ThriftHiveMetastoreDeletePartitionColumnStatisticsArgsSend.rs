...
pub struct ThriftHiveMetastoreDeletePartitionColumnStatisticsArgsSend {
    ...
    pub col_name: ::pilota::FastStr,
}
impl ::pilota::thrift::Message for ThriftHiveMetastoreDeletePartitionColumnStatisticsArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDeletePartitionColumnStatisticsArgsSend",
        };
        ...
        __protocol.write_faststr_field(4, (&self.col_name).clone())?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreDeletePartitionColumnStatisticsArgsSend` field(#{}) failed, caused by: ", field_id));
            }
        ...
        let Some(var_4) = var_4 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field col_name is required".to_string(),
            ));
        };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.faststr_field_len(Some(4), &self.col_name)
            + __protocol.field_stop_len()
