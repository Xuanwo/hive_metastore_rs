...
pub struct ThriftHiveMetastoreDeleteTableColumnStatisticsArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreDeleteTableColumnStatisticsArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDeleteTableColumnStatisticsArgsSend",
        };

        __protocol.write_struct_begin(&struct_ident)?;
        __protocol.write_faststr_field(1, (&self.db_name).clone())?;
        __protocol.write_faststr_field(2, (&self.tbl_name).clone())?;
        __protocol.write_faststr_field(3, (&self.col_name).clone())?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreDeleteTableColumnStatisticsArgsSend` field(#{}) failed, caused by: ", field_id));
            }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.faststr_field_len(Some(3), &self.col_name)
            + __protocol.field_stop_len()
