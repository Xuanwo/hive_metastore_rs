...
pub struct ThriftHiveMetastoreDropDatabaseArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreDropDatabaseArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDropDatabaseArgsSend",
        };

        __protocol.write_struct_begin(&struct_ident)?;
        __protocol.write_faststr_field(1, (&self.name).clone())?;
        __protocol.write_bool_field(2, *&self.delete_data)?;
        __protocol.write_bool_field(3, *&self.cascade)?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreDropDatabaseArgsSend` field(#{}) failed, caused by: ", field_id));
            }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.bool_field_len(Some(2), *&self.delete_data)
            + __protocol.bool_field_len(Some(3), *&self.cascade)
            + __protocol.field_stop_len()
