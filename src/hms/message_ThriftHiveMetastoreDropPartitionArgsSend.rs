...
pub struct ThriftHiveMetastoreDropPartitionArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreDropPartitionArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDropPartitionArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreDropPartitionArgsSend` field(#{}) failed, caused by: ", field_id));
            }
