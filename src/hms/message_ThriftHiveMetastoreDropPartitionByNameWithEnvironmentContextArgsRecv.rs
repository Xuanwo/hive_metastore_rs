...
pub struct ThriftHiveMetastoreDropPartitionByNameWithEnvironmentContextArgsRecv {
...
impl ::pilota::thrift::Message
    for ThriftHiveMetastoreDropPartitionByNameWithEnvironmentContextArgsRecv
{
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDropPartitionByNameWithEnvironmentContextArgsRecv",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreDropPartitionByNameWithEnvironmentContextArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
