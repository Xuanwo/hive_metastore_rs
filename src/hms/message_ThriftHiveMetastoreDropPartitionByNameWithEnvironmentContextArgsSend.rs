...
pub struct ThriftHiveMetastoreDropPartitionByNameWithEnvironmentContextArgsSend {
    pub db_name: ::pilota::FastStr,

    pub tbl_name: ::pilota::FastStr,

    pub part_name: ::pilota::FastStr,
...
impl ::pilota::thrift::Message
    for ThriftHiveMetastoreDropPartitionByNameWithEnvironmentContextArgsSend
{
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDropPartitionByNameWithEnvironmentContextArgsSend",
        };

        __protocol.write_struct_begin(&struct_ident)?;
        __protocol.write_faststr_field(1, (&self.db_name).clone())?;
        __protocol.write_faststr_field(2, (&self.tbl_name).clone())?;
        __protocol.write_faststr_field(3, (&self.part_name).clone())?;
        __protocol.write_bool_field(4, *&self.delete_data)?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreDropPartitionByNameWithEnvironmentContextArgsSend` field(#{}) failed, caused by: ", field_id));
            }
        ...
        let Some(var_3) = var_3 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field part_name is required".to_string(),
            ));
        };
        let Some(var_4) = var_4 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field delete_data is required".to_string(),
            ));
        };
        let Some(var_5) = var_5 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field environment_context is required".to_string(),
            ));
        };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.faststr_field_len(Some(3), &self.part_name)
            + __protocol.bool_field_len(Some(4), *&self.delete_data)
            + __protocol.struct_field_len(Some(5), &self.environment_context)
            + __protocol.field_stop_len()
