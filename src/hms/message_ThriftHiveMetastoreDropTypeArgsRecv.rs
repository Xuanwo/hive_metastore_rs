...
pub struct ThriftHiveMetastoreDropTypeArgsRecv {
    pub r#type: ::pilota::FastStr,
}
impl ::pilota::thrift::Message for ThriftHiveMetastoreDropTypeArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreDropTypeArgsRecv",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreDropTypeArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
