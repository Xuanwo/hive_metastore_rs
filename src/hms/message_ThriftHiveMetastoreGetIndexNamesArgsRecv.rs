...
impl ::std::default::Default for ThriftHiveMetastoreGetIndexNamesArgsRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetIndexNamesArgsRecv {
...
pub struct ThriftHiveMetastoreGetIndexNamesArgsRecv {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetIndexNamesArgsRecv {
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetIndexNamesArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.i16_field_len(Some(3), *&self.max_indexes)
            + __protocol.field_stop_len()
