...
impl ::std::default::Default for ThriftHiveMetastoreGetIndexNamesArgsSend {
    fn default() -> Self {
...
pub struct ThriftHiveMetastoreGetIndexNamesArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetIndexNamesArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetIndexNamesArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetIndexNamesArgsSend` field(#{}) failed, caused by: ", field_id));
            }
