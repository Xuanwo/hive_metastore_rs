...
impl ::std::default::Default for ThriftHiveMetastoreGetIndexesArgsRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetIndexesArgsRecv {
...
pub struct ThriftHiveMetastoreGetIndexesArgsRecv {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetIndexesArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetIndexesArgsRecv",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetIndexesArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
