...
impl ::std::default::Default for ThriftHiveMetastoreGetIndexesArgsSend {
    fn default() -> Self {
        ThriftHiveMetastoreGetIndexesArgsSend {
...
pub struct ThriftHiveMetastoreGetIndexesArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetIndexesArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetIndexesArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetIndexesArgsSend` field(#{}) failed, caused by: ", field_id));
            }
