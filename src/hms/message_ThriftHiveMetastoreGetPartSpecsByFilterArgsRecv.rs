...
impl ::std::default::Default for ThriftHiveMetastoreGetPartSpecsByFilterArgsRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartSpecsByFilterArgsRecv {
...
pub struct ThriftHiveMetastoreGetPartSpecsByFilterArgsRecv {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartSpecsByFilterArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartSpecsByFilterArgsRecv",
        };
        ...
        __protocol.write_i32_field(4, *&self.max_parts)?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartSpecsByFilterArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
            ...
            if let ::std::result::Result::Err(mut err) = async {
                loop {
                    ...
                    match field_ident.id {
                        ...
                        Some(4) if field_ident.field_type == ::pilota::thrift::TType::I32 => {
                            var_4 = __protocol.read_i32().await?;
                        }
                        _ => {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.i32_field_len(Some(4), *&self.max_parts)
            + __protocol.field_stop_len()
