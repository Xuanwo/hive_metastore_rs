...
impl ::std::default::Default for ThriftHiveMetastoreGetPartSpecsByFilterArgsSend {
    fn default() -> Self {
...
pub struct ThriftHiveMetastoreGetPartSpecsByFilterArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartSpecsByFilterArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartSpecsByFilterArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartSpecsByFilterArgsSend` field(#{}) failed, caused by: ", field_id));
            }
