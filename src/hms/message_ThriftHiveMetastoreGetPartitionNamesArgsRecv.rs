...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionNamesArgsRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartitionNamesArgsRecv {
...
pub struct ThriftHiveMetastoreGetPartitionNamesArgsRecv {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionNamesArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionNamesArgsRecv",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionNamesArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
