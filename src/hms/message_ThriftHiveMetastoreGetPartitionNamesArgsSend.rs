...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionNamesArgsSend {
    fn default() -> Self {
...
pub struct ThriftHiveMetastoreGetPartitionNamesArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionNamesArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionNamesArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionNamesArgsSend` field(#{}) failed, caused by: ", field_id));
            }
