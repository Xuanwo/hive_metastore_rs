...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionNamesPsArgsSend {
    fn default() -> Self {
...
pub struct ThriftHiveMetastoreGetPartitionNamesPsArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionNamesPsArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionNamesPsArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionNamesPsArgsSend` field(#{}) failed, caused by: ", field_id));
            }
