...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionsArgsSend {
    fn default() -> Self {
...
pub struct ThriftHiveMetastoreGetPartitionsArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionsArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionsArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionsArgsSend` field(#{}) failed, caused by: ", field_id));
            }
