...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionsByFilterArgsRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartitionsByFilterArgsRecv {
...
pub struct ThriftHiveMetastoreGetPartitionsByFilterArgsRecv {
    pub db_name: ::pilota::FastStr,

    pub tbl_name: ::pilota::FastStr,

    pub filter: ::pilota::FastStr,

    pub max_parts: i16,
}
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionsByFilterArgsRecv {
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionsByFilterArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
        ...
        let Some(var_3) = var_3 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field filter is required".to_string(),
            ));
        };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.faststr_field_len(Some(3), &self.filter)
