...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionsByFilterArgsSend {
    fn default() -> Self {
...
pub struct ThriftHiveMetastoreGetPartitionsByFilterArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionsByFilterArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionsByFilterArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionsByFilterArgsSend` field(#{}) failed, caused by: ", field_id));
            }
