...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionsPsArgsSend {
    fn default() -> Self {
...
pub struct ThriftHiveMetastoreGetPartitionsPsArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionsPsArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionsPsArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionsPsArgsSend` field(#{}) failed, caused by: ", field_id));
            }
