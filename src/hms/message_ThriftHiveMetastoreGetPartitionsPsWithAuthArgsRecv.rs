...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionsPsWithAuthArgsRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartitionsPsWithAuthArgsRecv {
            db_name: ::std::default::Default::default(),
            tbl_name: ::std::default::Default::default(),
            part_vals: ::std::default::Default::default(),
            max_parts: -1i16,
...
pub struct ThriftHiveMetastoreGetPartitionsPsWithAuthArgsRecv {
    pub db_name: ::pilota::FastStr,

    pub tbl_name: ::pilota::FastStr,

    pub part_vals: ::std::vec::Vec<::pilota::FastStr>,
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionsPsWithAuthArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionsPsWithAuthArgsRecv",
        };
        ...
        __protocol.write_i16_field(4, *&self.max_parts)?;
        __protocol.write_faststr_field(5, (&self.user_name).clone())?;
        __protocol.write_list_field(
            6,
            ::pilota::thrift::TType::Binary,
            &&self.group_names,
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionsPsWithAuthArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
        ...
        let Some(var_3) = var_3 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field part_vals is required".to_string(),
            ));
        };
            ...
            if let ::std::result::Result::Err(mut err) = async {
                loop {
                    ...
                    match field_ident.id {
                        ...
                        Some(4) if field_ident.field_type == ::pilota::thrift::TType::I16 => {
                            var_4 = __protocol.read_i16().await?;
                        }
                        Some(5) if field_ident.field_type == ::pilota::thrift::TType::Binary => {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.i16_field_len(Some(4), *&self.max_parts)
            + __protocol.faststr_field_len(Some(5), &self.user_name)
            + __protocol.list_field_len(
                Some(6),
                ::pilota::thrift::TType::Binary,
                &self.group_names,
