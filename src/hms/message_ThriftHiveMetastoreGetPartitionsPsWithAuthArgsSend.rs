...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionsPsWithAuthArgsSend {
    fn default() -> Self {
...
pub struct ThriftHiveMetastoreGetPartitionsPsWithAuthArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionsPsWithAuthArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionsPsWithAuthArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionsPsWithAuthArgsSend` field(#{}) failed, caused by: ", field_id));
            }
