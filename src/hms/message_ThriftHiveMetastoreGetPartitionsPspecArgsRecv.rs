...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionsPspecArgsRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartitionsPspecArgsRecv {
...
pub struct ThriftHiveMetastoreGetPartitionsPspecArgsRecv {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionsPspecArgsRecv {
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionsPspecArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
            ...
            if let ::std::result::Result::Err(mut err) = async {
                loop {
                    ...
                    match field_ident.id {
                        ...
                        Some(3) if field_ident.field_type == ::pilota::thrift::TType::I32 => {
                            var_3 = __protocol.read_i32().await?;
                        }
                        _ => {
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.i32_field_len(Some(3), *&self.max_parts)
            + __protocol.field_stop_len()
