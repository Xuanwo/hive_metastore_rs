...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionsPspecArgsSend {
    fn default() -> Self {
...
pub struct ThriftHiveMetastoreGetPartitionsPspecArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionsPspecArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionsPspecArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionsPspecArgsSend` field(#{}) failed, caused by: ", field_id));
            }
