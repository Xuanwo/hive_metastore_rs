...
impl ::std::default::Default for ThriftHiveMetastoreGetPartitionsWithAuthArgsRecv {
    fn default() -> Self {
        ThriftHiveMetastoreGetPartitionsWithAuthArgsRecv {
...
pub struct ThriftHiveMetastoreGetPartitionsWithAuthArgsRecv {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPartitionsWithAuthArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPartitionsWithAuthArgsRecv",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPartitionsWithAuthArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
