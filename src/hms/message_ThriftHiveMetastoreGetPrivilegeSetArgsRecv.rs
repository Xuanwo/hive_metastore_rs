...
pub struct ThriftHiveMetastoreGetPrivilegeSetArgsRecv {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetPrivilegeSetArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPrivilegeSetArgsRecv",
        };

        __protocol.write_struct_begin(&struct_ident)?;
        __protocol.write_struct_field(1, &self.hive_object, ::pilota::thrift::TType::Struct)?;
        __protocol.write_faststr_field(2, (&self.user_name).clone())?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetPrivilegeSetArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetPrivilegeSetArgsRecv",
        }) + __protocol.struct_field_len(Some(1), &self.hive_object)
            + __protocol.faststr_field_len(Some(2), &self.user_name)
