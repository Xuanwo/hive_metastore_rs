...
pub struct ThriftHiveMetastoreGetTableMetaArgsRecv {
    pub db_patterns: ::pilota::FastStr,

    pub tbl_patterns: ::pilota::FastStr,

    pub tbl_types: ::std::vec::Vec<::pilota::FastStr>,
}
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetTableMetaArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetTableMetaArgsRecv",
        };

        __protocol.write_struct_begin(&struct_ident)?;
        __protocol.write_faststr_field(1, (&self.db_patterns).clone())?;
        __protocol.write_faststr_field(2, (&self.tbl_patterns).clone())?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetTableMetaArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
        ...
        let Some(var_1) = var_1 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ...
                "field db_patterns is required".to_string(),
            ));
        };
        let Some(var_2) = var_2 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field tbl_patterns is required".to_string(),
            ));
        };
        let Some(var_3) = var_3 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field tbl_types is required".to_string(),
            ));
        };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetTableMetaArgsRecv",
        }) + __protocol.faststr_field_len(Some(1), &self.db_patterns)
            + __protocol.faststr_field_len(Some(2), &self.tbl_patterns)
