...
impl ::std::default::Default for ThriftHiveMetastoreGetTableNamesByFilterArgsSend {
    fn default() -> Self {
...
pub struct ThriftHiveMetastoreGetTableNamesByFilterArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetTableNamesByFilterArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetTableNamesByFilterArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetTableNamesByFilterArgsSend` field(#{}) failed, caused by: ", field_id));
            }
