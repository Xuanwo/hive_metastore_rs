...
pub struct ThriftHiveMetastoreGetTableObjectsByNameArgsSend {
    pub dbname: ::pilota::FastStr,

    pub tbl_names: ::std::vec::Vec<::pilota::FastStr>,
}
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetTableObjectsByNameArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetTableObjectsByNameArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetTableObjectsByNameArgsSend` field(#{}) failed, caused by: ", field_id));
            }
        ...
        let Some(var_2) = var_2 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field tbl_names is required".to_string(),
            ));
        };
