...
pub struct ThriftHiveMetastoreGetTablesArgsRecv {
    pub db_name: ::pilota::FastStr,

    pub pattern: ::pilota::FastStr,
}
impl ::pilota::thrift::Message for ThriftHiveMetastoreGetTablesArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreGetTablesArgsRecv",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreGetTablesArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
