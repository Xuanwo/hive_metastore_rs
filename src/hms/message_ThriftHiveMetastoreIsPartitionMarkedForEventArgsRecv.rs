...
pub struct ThriftHiveMetastoreIsPartitionMarkedForEventArgsRecv {
    pub db_name: ::pilota::FastStr,

    pub tbl_name: ::pilota::FastStr,

    pub part_vals: ::pilota::AHashMap<::pilota::FastStr, ::pilota::FastStr>,

    pub event_type: PartitionEventType,
}
impl ::pilota::thrift::Message for ThriftHiveMetastoreIsPartitionMarkedForEventArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreIsPartitionMarkedForEventArgsRecv",
        };
        ...
        __protocol.write_i32_field(4, (&self.event_type).inner())?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreIsPartitionMarkedForEventArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
            ...
            if let ::std::result::Result::Err(mut err) = async {
                loop {
                    ...
                    match field_ident.id {
                        ...
                        Some(4) if field_ident.field_type == ::pilota::thrift::TType::I32 => {
                            var_4 = Some(
                                <PartitionEventType as ::pilota::thrift::Message>::decode_async(
                                    __protocol,
                                )
                                .await?,
                            );
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.i32_field_len(Some(4), (&self.event_type).inner())
            + __protocol.field_stop_len()
