...
pub struct ThriftHiveMetastoreIsPartitionMarkedForEventArgsSend {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreIsPartitionMarkedForEventArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreIsPartitionMarkedForEventArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreIsPartitionMarkedForEventArgsSend` field(#{}) failed, caused by: ", field_id));
            }
