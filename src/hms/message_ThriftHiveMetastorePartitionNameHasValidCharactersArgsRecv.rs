...
pub struct ThriftHiveMetastorePartitionNameHasValidCharactersArgsRecv {
    pub part_vals: ::std::vec::Vec<::pilota::FastStr>,

    pub throw_exception: bool,
}
impl ::pilota::thrift::Message for ThriftHiveMetastorePartitionNameHasValidCharactersArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastorePartitionNameHasValidCharactersArgsRecv",
        };
        ...
        __protocol.write_bool_field(2, *&self.throw_exception)?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastorePartitionNameHasValidCharactersArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
        ...
        let Some(var_2) = var_2 else {
            return ::std::result::Result::Err(::pilota::thrift::new_protocol_exception(
                ::pilota::thrift::ProtocolExceptionKind::InvalidData,
                "field throw_exception is required".to_string(),
            ));
        };

        let data = Self {
            part_vals: var_1,
            throw_exception: var_2,
        };
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        ) + __protocol.bool_field_len(Some(2), *&self.throw_exception)
            + __protocol.field_stop_len()
