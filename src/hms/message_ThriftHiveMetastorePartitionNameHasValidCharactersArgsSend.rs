...
pub struct ThriftHiveMetastorePartitionNameHasValidCharactersArgsSend {
    pub part_vals: ::std::vec::Vec<::pilota::FastStr>,

    pub throw_exception: bool,
}
impl ::pilota::thrift::Message for ThriftHiveMetastorePartitionNameHasValidCharactersArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastorePartitionNameHasValidCharactersArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastorePartitionNameHasValidCharactersArgsSend` field(#{}) failed, caused by: ", field_id));
            }
