...
pub struct ThriftHiveMetastoreRenamePartitionArgsRecv {
...
impl ::pilota::thrift::Message for ThriftHiveMetastoreRenamePartitionArgsRecv {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreRenamePartitionArgsRecv",
        };
        ...
        __protocol.write_struct_field(4, &self.new_part, ::pilota::thrift::TType::Struct)?;
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreRenamePartitionArgsRecv` field(#{}) failed, caused by: ", field_id));
            }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
            ...
            + __protocol.struct_field_len(Some(4), &self.new_part)
            + __protocol.field_stop_len()
