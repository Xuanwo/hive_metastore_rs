...
pub struct ThriftHiveMetastoreSetUgiArgsSend {
    pub user_name: ::pilota::FastStr,

    pub group_names: ::std::vec::Vec<::pilota::FastStr>,
}
impl ::pilota::thrift::Message for ThriftHiveMetastoreSetUgiArgsSend {
    fn encode<T: ::pilota::thrift::TOutputProtocol>(
        ...
        let struct_ident = ::pilota::thrift::TStructIdentifier {
            name: "ThriftHiveMetastoreSetUgiArgsSend",
        };
    ...
    fn decode<T: ::pilota::thrift::TInputProtocol>(
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!("decode struct `ThriftHiveMetastoreSetUgiArgsSend` field(#{}) failed, caused by: ", field_id));
            }
