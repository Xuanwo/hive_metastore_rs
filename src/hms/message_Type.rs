...
pub struct Type {
    ...
    pub type1: ::std::option::Option<::pilota::FastStr>,

    pub type2: ::std::option::Option<::pilota::FastStr>,

    pub fields: ::std::option::Option<::std::vec::Vec<FieldSchema>>,
}
impl ::pilota::thrift::Message for Type {
        ...
        if let ::std::result::Result::Err(mut err) = (|| {
            ...
            if let Some(field_id) = __pilota_decoding_field_id {
                err.prepend_msg(&format!(
                    "decode struct `Type` field(#{}) failed, caused by: ",
                    field_id
                ));
            }
    ...
    fn size<T: ::pilota::thrift::TLengthProtocol>(&self, __protocol: &mut T) -> usize {
        ...
        __protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier { name: "Type" })
            + self
                .name
                .as_ref()
            ...
            + self.fields.as_ref().map_or(0, |value| {
